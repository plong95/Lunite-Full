...
public class RSFontSystem extends DrawingArea {
    ...
    public static String handleOldSyntax(String text) {
        ...
        text = text.replaceAll("@rs1@", "<col=cfa75a>");
                    ...
                    if (effectString.equals(startEffect)) {
                        ...
                        if (effectString.startsWith(startIcon)) {
                            try {
                                ...
                                int iconModY = icon.myHeight;
                                if (transparency == 256) {
                                    icon.drawSprite(drawX - 2, drawY + baseCharacterHeight + offsetY - iconModY);
                                } else {
                                    icon.drawSprite(drawX - 2, drawY + baseCharacterHeight + offsetY - iconModY, transparency);
                                }
                                drawX += icon.myWidth;
                            } catch (Exception exception) {
                                /* empty */
                        ...
                        if (effectString.equals(startEffect)) {
                            ...
                            if (effectString.startsWith(startImage)) {
                                try {// <img=
                                    ...
                                    int iconWidth = Client.cacheSprite[iconId].myWidth;
