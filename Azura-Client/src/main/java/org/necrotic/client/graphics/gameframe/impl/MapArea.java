...
//MONEY POUCH
		/*if (client.inSprite(false, Client.cacheSprite[566], getxPos() + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 90 : -2),
				GameFrame.getScreenMode() != ScreenMode.FIXED ? 160 : 82)) {
			client.menuActionName[4] = "Show money pouch";
			client.menuActionID[4] = 712;
			client.menuActionName[3] = "Withdraw money pouch";
			client.menuActionID[3] = 713;
			client.menuActionName[2] = "Withdraw 1M Tickets";
			client.menuActionID[2] = 714;
		...
		if (client.inSprite(false, Client.cacheSprite[1423], getxPos() + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 125 : 35), getyPos() + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 160 : 137))) { //handleglobe
	...
	protected void render(Client client, ScreenMode screenMode) {
		if (isVisible()) {
			...
			if (client.inSprite(false, Client.cacheSprite[1423], getxPos()  + (screenMode != ScreenMode.FIXED ? 125 : 35), getyPos() + (screenMode != ScreenMode.FIXED ? 160 : 137))) { //handleglobe
				Client.cacheSprite[1424].drawSprite(getOffSetX() + (screenMode != ScreenMode.FIXED ? 125 : 35), getOffSetY() + (screenMode != ScreenMode.FIXED ? 160 : 137));
			} else {
				Client.cacheSprite[1423].drawSprite(getOffSetX() + (screenMode != ScreenMode.FIXED ? 125 : 35), getOffSetY() + (screenMode != ScreenMode.FIXED ? 160 : 137));
			}
