...
public class Load {
    ...
    public static void settings(Client client) {
        ...
        try (FileReader fileReader = new FileReader(file)) {
            ...
            if (reader.has("animated-texture")) {
                Configuration.ANIMATE_TEXTURES = reader.get("animated-texture").getAsBoolean();
            }
            if (reader.has("player-equipment")) {
                Configuration.PLAYER_EQUIPMENT = reader.get("player-equipment").getAsBoolean();
            }
