...
public class FloorDefinitionOSRS {
	...
	public static void unpackConfig(Archive streamLoader) {
		ByteBuffer buffer = ByteBuffer.wrap(streamLoader.get("floosrs.dat"));
		//Stream buffer = new Stream(streamLoader.getDataForName("flo.dat"));

		int underlayAmount = buffer.getShort();
		System.out.println("underlayAmount: " + underlayAmount);
