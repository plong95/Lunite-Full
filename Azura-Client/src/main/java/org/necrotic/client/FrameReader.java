...
public final class FrameReader {
    ...
    public static void initialise(int i) {
        ...
        animationListOldschool = new FrameReader[100000][0];
    }
    ...
    public static FrameReader forId(int int1, boolean osrs) {
        try {
            ...
            if (osrs) {
                ...
                if (animationListOldschool[file].length == 0) {
                    Client.instance.onDemandFetcher.requestFileData(Client.OSRS_ANIM_IDX - 1, file);
                    return null;
                }
                return animationListOldschool[file][int1];
            } else {
                int file = int1 >> 16;
                int1 = int1 & 0xffff;
                ...
                return animationlist[file][int1];
            }
        } catch (Exception e) {
            e.printStackTrace();
            return null;
