...
import org.necrotic.client.Partyhat;
...
public final class Player extends Entity {
    ...
    public Model getRotatedModel() {
        ...
        if (super.gfxId != -1 && super.currentAnim != -1) {
            ...
            if (model_2 != null) {
                ...
                model_3.interpolateFrames(spotAnim.animation.frameIDs[super.currentAnim], nextFrame, cycle1, cycle2, false);
	 ...
	 */
        ...
        if (model_1 == null) {
            ...
            for (int i2 = 0; i2 < 13; i2++) {
                ...
                if (k2 >= 512 && !ItemDefinition.get(k2 - 512).method195(myGender, !Configuration.RENDER_PLAYER_BODY)) {
                    flag = true;
                }
            }
        ...
        if (model_1 == null) {
            ...
            for (int l2 = 0; l2 < 13; l2++) {
                ...
                if (i3 >= 512) {
                    Model model_4 = ItemDefinition.get(i3 - 512).method196(myGender, !Configuration.RENDER_PLAYER_BODY);
        ...
        if (currentFrame != -1 && i1 != -1) {
            model_2.method471(Animation.cache[super.anim].animationFlowControl, i1, currentFrame, false);
        } else if (currentFrame != -1 && nextFrame != -1 && Configuration.TWEENING_ENABLED) {
            model_2.interpolateFrames(currentFrame, nextFrame, cycle1, cycle2, false);
        } else {
    ...
    public void updatePlayer(ByteBuffer stream) {
        ...
        gameMode = stream.getUnsignedShort();//may isee ur character files?
        loyaltyTitle = stream.getString();
