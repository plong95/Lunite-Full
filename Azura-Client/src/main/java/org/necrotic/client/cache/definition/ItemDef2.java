    ...
    public static ItemDefinition newIDS(ItemDefinition itemDef, int id) {
        ...
        switch (id) {
            ...
            case 18752:
                ...
                itemDef.modelID = 139745;
                itemDef.maleEquip1 = 139746;
            ...
            case 18750:
                ...
                itemDef.name = "<col=eed81d><shad=9283>Corrupt Maxiblood Spear<shad-1>";
                itemDef.modelID = 139749;
                itemDef.maleEquip1 = 139750;
                itemDef.femaleEquip1 = 139750;
            ...
            case 18629:
                ...
                itemDef.modelID = 139737;
                itemDef.maleEquip1 = 139738;
                itemDef.femaleEquip1 = 139738;
                itemDef.modelZoom = 2300;
                itemDef.rotationX = 1100;
                itemDef.rotationY = 450;
                itemDef.modelOffsetX = 0;
            ...
            case 18636:
                ...
                itemDef.modelID = 130927;
                itemDef.femaleEquip1 = 130926;
                itemDef.maleEquip1 = 130926;
            ...
            case 8253:
                ...
                itemDef.newColors[1] = 71; // the new texture u want it to have
            ...
            case 15330:
                ...
                itemDef.actions = new String[]{"Drink", null, "Upgrade", null, "Destroy"};
                break;
            ...
            case 15290:
                ...
                itemDef.stackable = false;
                itemDef.actions = new String[]{"Open", null, "Open-all", null, "Destroy"};
            ...
            case 20083:
                ...
                //itemDef.stackable = true;
                itemDef.actions = new String[]{"Pull", null, null, null, "Destroy"};
                itemDef.rdc2 = 294295;
                break;
            case 19775:
            ...
            case 882:
                ...
                break;
            case 17600:
                itemDef.name = "<col=a69eb6>Titan Celestial Staff";
            ...
            case 7014:
                ...
                itemDef.newColors = new int[]{70, 70};
                break;
            case 9360:
...
//	itemDef.modelOffsetX = itemDef2.modelOffsetX;
            ...
            case 9364:
                ...
                itemDef.oldColors = new int[1]; // same here
                itemDef.oldColors[0] = 40; // the texture that it currently has
                itemDef.newColors[0] = 73; // the new texture u want it to have
                itemDef.stackable = false;
            ...
            case 20551:
                ...
                itemDef.actions = new String[]{null, "Wear", null, null, "Destroy"};
                itemDef.oldColors = new int[]{60, 62};
                itemDef.newColors = new int[]{68, 68};
                //itemDef.rdc2 = 7007;
                break;
            case 20558:
                itemDef.modelID = 65341;
                ...
                itemDef.actions = new String[]{null, "Wear", null, null, "Destroy"};
                itemDef.oldColors = new int[]{60, 62};
                itemDef.newColors = new int[]{57, 57};
                //itemDef.rdc2 = 7007;
                break;
            case 20559:
            ...
            case 4017:
                ...
                itemDef.actions = new String[]{null, "Wear", null, null, "Destroy"};
                itemDef.oldColors = new int[]{60, 62};
                itemDef.newColors = new int[]{59, 59};
                //itemDef.rdc2 = 7007;
                break;
            case 4018:
            ...
            case 5432:
                ...
                itemDef.actions = new String[]{null, "Wear", null, null, "Destroy"};
                itemDef.oldColors = new int[]{60, 62};
                itemDef.newColors = new int[]{71, 71};
                //itemDef.rdc2 = 7007;
                break;
            case 522:
            ...
            case 8830:
                ...
                itemDef.newColors[0] = 63;
                itemDef.oldColors[1] = 65; // the texture that it currently has
                itemDef.newColors[1] = 63; // the new texture u want it to have
                itemDef.stackable = false;
                itemDef.value = 1;
                break;
            case 8812:
            ...
            case 16835:
                ...
                itemDef.oldColors = new int[1]; // same here
                itemDef.oldColors[0] = 40; // the texture that it currently has
                itemDef.newColors[0] = 61; // the new texture u want it to have
                itemDef.stackable = false;
                break;
            case 5154:
            ...
            case 2025:
                ...
                break;
            case 2026:
                itemDef.name = "Vote Bones";
                itemDef.oldColors = new int[]{63};//old
                itemdefyogipic = ItemDefinition.get(526);
                itemDef.newColors = new int[]{83};//new
                itemDef.actions = itemdefyogipic.actions;
                itemDef.modelID = 65285;
                itemDef.modelZoom = 1500;
                break;
            ...
            case 8810:
                ...
                itemDef.name = "<col=7f39f2>Shadow Wings";
                itemDef.newColors = new int[1]; // if only 1 texture is modified this has to be 1, if 2 then 2 etc
                itemDef.oldColors = new int[1]; // same here
                itemDef.oldColors[0] = 59; // the texture that it currently has
                itemDef.newColors[0] = 71; //
                itemDef.actions = new String[5];
                itemDef.actions[4] = "Destroy";
                itemDef.actions[1] = "Wear";
            ...
            case 15888:
                ...
                itemDef.actions = new String[]{null, "Wear", null, null, "Destroy"};
                itemDef.oldColors = new int[]{59, 40};
            ...
            case 13802:
                ...
                itemDef.oldColors = new int[]{ 2999, 926,22410};
                itemDef.newColors = new int[]{19197,20386,  20386};
                break;
