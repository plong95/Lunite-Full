                ...
                case 1:
                    ...
                    if (loc != Location.DUNGEONEERING && loc != Location.PEST_CONTROL_GAME && loc != Location.DUEL_ARENA
                        ...
                        if (player.getRights().equals(PlayerRights.ADMINISTRATOR)
                                || player.getRights().equals(PlayerRights.MANAGER)
                        ...
                        if (loc == Location.WILDERNESS) {
                            if (killer != null && (killer.getRights().equals(PlayerRights.ADMINISTRATOR)
                                    || killer.getRights().equals(PlayerRights.MANAGER)
                        ...
                        if (killer != null) {
                            if (killer.getRights().equals(PlayerRights.MANAGER)
                                    || killer.getRights().equals(PlayerRights.ADMINISTRATOR)
                                    || killer.getRights().equals(PlayerRights.DEVELOPER)) {
                                dropItems = false;
                            }
                        }
                        if (loc == Location.NOMAD) {
