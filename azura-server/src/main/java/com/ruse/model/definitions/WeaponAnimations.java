...
public final class WeaponAnimations {
	...
	public static CharacterAnimations getUpdateAnimation(Player player) {
		...
		if (weaponName.contains("halberd") || weaponName.contains("guthan")) {
			...
			playerRunIndex = 1210;
			playerWalkIndex = 1146;
		} else if (weaponName.contains("karil") || weaponId == 23355 || weaponId == 22089 || weaponId == 23832|| weaponId == 23839|| weaponId == 23891) {
			playerStandIndex = 2074;
			playerWalkIndex = 2076;
			playerRunIndex = 2077;
		} else if (weaponName.contains("2h sword") || weaponName.contains("godsword")
				|| weaponName.contains("saradomin sw")|| weaponId == 23840) {
	...
	public static int getAttackAnimation(Player c) {
		...
		if (weaponId == 21606)
			return 4230;
		if (weaponId == 19137 || weaponId == 19135 || weaponId == 671 || weaponId == 19136  || weaponId == 23710|| weaponId == 8253 || weaponId == 18636 || weaponId == 19843 || weaponId == 19843
				|| weaponId == 17712)// Minigun
			return 12153;
		if (weaponId == 17704 || weaponId == 23663)
			return 4230;
		...
		if (weaponName.contains("2h sword") || weaponName.contains("godsword")
				|| weaponName.contains("saradomin sword")|| weaponId == 23840) {
			/*
		...
		if (weaponName.contains("karil") || weaponId == 22089 || weaponId == 23832 || weaponId == 23839 || weaponId == 23891)
			return 2075;
