...
public class NpcDefinition {
	...
	private static NpcDefinition[] definitions = new NpcDefinition[30000];
	...
	public static JsonLoader parseNpcs() {
		return new JsonLoader() {
			...
			public void load(JsonObject reader, Gson builder) {
				...
				if (reader.has("boss")) {
					definitions[index].boss = reader.get("boss").getAsBoolean();
				} else {
	 ...
	 * 
	 * @param examine the examine info to set.
	 */
	 ...
	 * 
	 * @param size the npc size to set.
	 */
	 ...
	 * 
	 * @param retreats the retreats to set.
	 */
	 ...
	 * 
	 * @param maxHit the max hit to set.
	 */
	 ...
	 * 
	 * @param defenceMelee the defence melee to set.
	 */
	 ...
	 * 
	 * @param defenceRange the defence range to set.
	 */
	 ...
	 * 
	 * @param defenceMage the defence mage to set.
	 */
