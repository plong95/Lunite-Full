...
public final class WeaponInterfaces {
	...
	public enum WeaponInterface {
		...
		MACE(3796, 3799, 4,
				...
				7624, 7636),
		KNIFE(4446, 4449, 4,
				new FightType[] { FightType.KNIFE_ACCURATE, FightType.KNIFE_RAPID, FightType.KNIFE_LONGRANGE }, 7649,
				7661),
		SPEAR(4679, 4682, 6,
		...
		CLAWS(7762, 7765, 4,
				...
				7800, 7812),
		HALBERD(8460, 8463, 6,
				new FightType[] { FightType.HALBERD_JAB, FightType.HALBERD_SWIPE, FightType.HALBERD_FEND }, 8493, 8505),
		UNARMED(5855, 5857, 6,
				new FightType[] { FightType.UNARMED_PUNCH, FightType.UNARMED_KICK, FightType.UNARMED_BLOCK }),
		WHIP(12290, 12293, 4, new FightType[] { FightType.WHIP_FLICK, FightType.WHIP_LASH, FightType.WHIP_DEFLECT },
				12323, 12335),
		THROWNAXE(4446, 4449, 6,
				new FightType[] { FightType.THROWNAXE_ACCURATE, FightType.THROWNAXE_RAPID,
						FightType.THROWNAXE_LONGRANGE },
				7649, 7661),
		DART(4446, 4449, 4, new FightType[] { FightType.DART_ACCURATE, FightType.DART_RAPID, FightType.DART_LONGRANGE },
				7649, 7661),
		JAVELIN(4446, 4449, 6,
				new FightType[] { FightType.JAVELIN_ACCURATE, FightType.JAVELIN_RAPID, FightType.JAVELIN_LONGRANGE },
				7649, 7661),
		BLOWPIPE(1764, 1767, 3,
				new FightType[] { FightType.BLOWPIPE_ACCURATE, FightType.BLOWPIPE_RAPID, FightType.BLOWPIPE_LONGRANGE },
				7549, 7561),
		BSOAT(1764, 1767, 1,
				new FightType[] { FightType.BSOAT_ACCURATE, FightType.BSOAT_RAPID, FightType.BSOAT_LONGRANGE }, 7549,
				7561),
		ARMADYLXBOW(1764, 1767, 5, new FightType[] { FightType.ARMADYLXBOW_ACCURATE, FightType.ARMADYLXBOW_RAPID,
				FightType.ARMADYLXBOW_LONGRANGE }, 7549, 7561);
		 ...
		 */
		private WeaponInterface(int interfaceId, int nameLineId, int speed, FightType[] fightType, int specialBar,
				int specialMeter) {
	...
	public static void assign(Player player, Item item) {
		...
		player.getPacketSender().sendTabInterface(0, weapon.getInterfaceId());
		player.getPacketSender().sendString(weapon.getNameLineId(), item.getDefinition().getName());
		...
		for (FightType type : weapon.getFightType()) {
			...
			if (type.getStyle() == player.getFightType().getStyle()) {
				...
				player.getPacketSender().sendConfig(player.getFightType().getParentId(),
