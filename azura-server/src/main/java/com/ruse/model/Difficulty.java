...
public enum Difficulty {
	...
	public static void set(Player player, Difficulty newMode, boolean force) {
		...
		if (force) {
			...
			if (newMode == FUN && !player.getRights().isHighStaff()) {
	 ...
	 * player.getPacketSender().sendMessage("You've set your newgamemode to "
