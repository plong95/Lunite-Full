...
public class Position {
    ...
    public String toString() {
        return "Position values: [" + getRegionId() + ", " + x + ", " + y + ", " + z + "] - [region, x, y, z].";
    }
    ...
    public static Position closestPoint(Position startPosition, Position endPosition, int size) {
        Position closestPosition = startPosition.copy();
        if (size == 1)
            return  closestPosition;
        if (endPosition.getX() >= startPosition.getX() + size) {
            closestPosition = closestPosition.setX(startPosition.getX() + size - 1).setY(endPosition.getY());
        } else if (endPosition.getX() <= startPosition.getX() - 1) {
            closestPosition = closestPosition.setX(startPosition.getX()).setY(endPosition.getY());
        }

        if (endPosition.getY() >= startPosition.getY() + size) {
            closestPosition = closestPosition.setY(startPosition.getY() + size - 1).setX(endPosition.getX());
        } else if (endPosition.getY() <= startPosition.getY() - 1) {
            closestPosition = closestPosition.setY(startPosition.getY()).setX(endPosition.getX());
        }
        return closestPosition;
    }
