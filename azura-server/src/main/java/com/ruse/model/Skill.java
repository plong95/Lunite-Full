...
public enum Skill {
	...
	FISHING(6258, 1, 8, 9798, 9799, -1, 10000, 81, 65, 49, 32, 85), // done
	...
	MINING(4416, 3, 2, 9792, 9793, -1, 10000, 125, 100, 75, 50, 85), // done
	...
	INVENTION(7267, 3, 21, 9789, 9790, -1, 1, 1, 1, 1, 1, 1), // done
	HUNTER(8267, 3, 22, 9948, 9949, 22024, 10000, 131, 105, 79, 53, 79), // done
	SUMMONING(9267, 5, 23, 12169, 12170, 22033, 10000, 134, 107, 80, 54, 80), // done
	PVP(10267, 5, 24, 18508, 18509, -1, 10000, 5, 4, 3, 2, 2);
	//ATTACK_MODIFIER = 230;
	/*
	 * public static final int ATTACK_MODIFIER = 230; public static final int
	 * DEFENCE_MODIFIER = 230; public static final int STRENGTH_MODIFIER = 230;
	 * public static final int CONSTITUTION_MODIFIER = 190; public static final int
	 * RANGED_MODIFIER = 260; public static final int PRAYER_MODIFIER = 50; public
	 * static final int MAGIC_MODIFIER = 290; public static final int
	 * HERBLORE_MODIFIER = 5; public static final int CRAFTING_MODIFIER = 3; public
	...
	/**
	 * The skill's chatbox interface The interface which will be sent on levelup.
	 */
	...
	/**
	 * Get's the amount of points the player will receive for prestiging the skill.
	 * 
