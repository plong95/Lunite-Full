...
public class UseItemPacketListener implements PacketListener {
    ...
    private static void itemOnItem(Player player, Packet packet) {
        ...
        if (SpecialAmmo.forId(usedWith.getId()) != null) {
            SpecialAmmo.upgrade(player, player.getInventory().getItems()[usedWithSlot]);
        }
        if (SpecialAmmo.forId(itemUsedWith.getId()) != null) {
            SpecialAmmo.upgrade(player, player.getInventory().getItems()[itemUsedSlot]);
        }
        ...
        if (itemUsedWith.getId() == TreasureHunter.KEY_1 || itemUsedWith.getId() == TreasureHunter.KEY_2
                | itemUsedWith.getId() == TreasureHunter.KEY_3 || itemUsedWith.getId() == TreasureHunter.KEY_4) {
            TreasureHunter.combineKeys(player, itemUsedWith, usedWith);
            return;
        }
        ...
        if (itemUsedWith.getId() == 23534 && (usedWith.getId() >= 23465 && usedWith.getId() <= 23473)) {
            if (player.getInventory().getAmount(23534) >= 1000 && player.getInventory().contains(usedWith.getId())) {
                int toCreate = usedWith.getId() + 60;
                player.getInventory().delete(23534, 1000);
                player.getInventory().delete(usedWith.getId(), 1);
                player.getInventory().add(toCreate, 1);
                World.sendMessage("<img=5>@blu@[Upgrade]<img=5> @red@" + player.getUsername() + "@blu@ has created a @red@"
                        + ItemDefinition.forId(toCreate).getName());
                return;
            }else{
                DialogueManager.sendStatement(player, "You need at least 1,000 Sanctum crystals to do this.");
            }
        }

        if (usedWith.getId() == 23534 && (itemUsedWith.getId() >= 23465 && itemUsedWith.getId() <= 23473)) {
            if (player.getInventory().getAmount(23534) >= 1000 && player.getInventory().contains(itemUsedWith.getId())) {
                int toCreate = itemUsedWith.getId() + 60;
                player.getInventory().delete(23534, 1000);
        ...
        if ((usedWith.getId() == 17580 && itemUsedWith.getId() == 23300)
                || (itemUsedWith.getId() == 17580 && usedWith.getId() == 23300)) {
            if (player.getInventory().contains(17580) && player.getInventory().contains(23300)) {
                int[] rewards = new int[]{23301, 23302, 23303, 23304, 23305, 23306, 23309};
                ...
                player.getInventory().delete(23300, 1);
        ...
        if ((usedWith.getId() == 23401 && itemUsedWith.getId() == 20592)
                || (itemUsedWith.getId() == 23401 && usedWith.getId() == 20592)) {
            if (player.getInventory().contains(23401) && player.getInventory().contains(20592)) {
                player.getInventory().delete(20592, 1);
                player.getInventory().delete(23401, 1);
                player.getInventory().add(23403, 1);
                return;
            }
        }

        if ((usedWith.getId() == 23511 && itemUsedWith.getId() == 23459)
                || (itemUsedWith.getId() == 23511 && usedWith.getId() == 23459)) {
            if (player.getInventory().contains(23511) && player.getInventory().contains(23459)) {
                player.getInventory().delete(23459, 1);
                player.getInventory().delete(23511, 1);
                player.getInventory().add(23512, 1);
                return;
            }
        }
/*
        if (usedWith.getId() == 22112) {
            Item attachmentCost = new Item(22112, 3);
            Item pvmCost = new Item(5022, 5_000_000);
            Item upgradesCost = new Item(12855, 10_000_000);
            Item[] requirements = new Item[]{attachmentCost, pvmCost, upgradesCost, new Item(5011, 1)};
            if (player.getInventory().containsAll(requirements) && requirements[3].getId() == itemUsedWith.getId()) {
                if (Misc.exclusiveRandom(1, 100) <= 10) {
                    player.getInventory().deleteItemSet(requirements);
                    player.getInventory().add(22113, 1);
                    player.sendMessage("@red@Congratulations, you've made the Dark Twisted Bow!");
                    String msg = "@blu@<img=5>[CREATION]<img=5>@red@ " + player.getUsername() + " has created a Dark Twisted Bow!";
                    World.sendMessage(msg);
                } else {
                    player.getInventory().delete(attachmentCost);
                    player.getInventory().delete(pvmCost);
                    player.getInventory().delete(upgradesCost);
                    player.sendMessage("@red@You've failed to make the dark item and lost some of the ingredients!");
                }
                return;
            }
            requirements = new Item[]{attachmentCost, pvmCost, upgradesCost, new Item(17013, 1)};
            if (player.getInventory().containsAll(requirements) && requirements[3].getId() == itemUsedWith.getId()) {
                if (Misc.exclusiveRandom(1, 100) <= 10) {
                    player.getInventory().deleteItemSet(requirements);
                    player.getInventory().add(22114, 1);
                    player.sendMessage("@red@Congratulations, you've made the Dark Sanguinesti Staff!");
                    String msg = "@blu@<img=5>[CREATION]<img=5>@red@ " + player.getUsername() + " has created a Dark Sanguinesti Staff!";
                    World.sendMessage(msg);
                } else {
                    player.getInventory().delete(attachmentCost);
                    player.getInventory().delete(pvmCost);
            ...
            requirements = new Item[]{attachmentCost, pvmCost, upgradesCost, new Item(12537, 1)};
            if (player.getInventory().containsAll(requirements) && requirements[3].getId() == itemUsedWith.getId()) {
                if (Misc.exclusiveRandom(1, 100) <= 10) {
                    player.getInventory().deleteItemSet(requirements);
                    player.getInventory().add(22115, 1);
                    player.sendMessage("@red@Congratulations, you've made the Dark Scythe Of Vitur!");
                    String msg = "@blu@<img=5>[CREATION]<img=5>@red@ " + player.getUsername() + " has created a Dark Scythe Of Vitur!";
                    World.sendMessage(msg);
                } else {
                    player.getInventory().delete(attachmentCost);
                    player.getInventory().delete(pvmCost);
        ...
        if (usedWith.getId() == 23223) {
            Item attachmentCost = new Item(23223, 3);
            Item pvmCost = new Item(5022, 20_000_000);
            Item upgradesCost = new Item(12855, 50_000_000);
            Item[] requirements = new Item[]{attachmentCost, pvmCost, upgradesCost, new Item(22113, 1)};
            if (player.getInventory().containsAll(requirements) && requirements[3].getId() == itemUsedWith.getId()) {
                if (Misc.exclusiveRandom(1, 100) <= 10) {
                    player.getInventory().deleteItemSet(requirements);
                    player.getInventory().add(23222, 1);
                    player.sendMessage("@red@Congratulations, you've made the Blood Twisted Bow!");
                    String msg = "@blu@<img=5>[CREATION]<img=5>@red@ " + player.getUsername() + " has created a Blood Twisted Bow!";
                    World.sendMessage(msg);
                } else {
                    player.getInventory().delete(attachmentCost);
                    player.getInventory().delete(pvmCost);
                    player.getInventory().delete(upgradesCost);
                    player.sendMessage("@red@You've failed to make the Blood item and lost some of the ingredients!");
                }
                return;
            }
            requirements = new Item[]{attachmentCost, pvmCost, upgradesCost, new Item(22114, 1)};
            if (player.getInventory().containsAll(requirements) && requirements[3].getId() == itemUsedWith.getId()) {
                if (Misc.exclusiveRandom(1, 100) <= 10) {
                    player.getInventory().deleteItemSet(requirements);
                    player.getInventory().add(23220, 1);
                    player.sendMessage("@red@Congratulations, you've made the Blood Sanguinesti Staff!");
                    String msg = "@blu@<img=5>[CREATION]<img=5>@red@ " + player.getUsername() + " has created a Blood Sanguinesti Staff!";
                    World.sendMessage(msg);
                } else {
                    player.getInventory().delete(attachmentCost);
                    player.getInventory().delete(pvmCost);
            ...
            requirements = new Item[]{attachmentCost, pvmCost, upgradesCost, new Item(22115, 1)};
            if (player.getInventory().containsAll(requirements) && requirements[3].getId() == itemUsedWith.getId()) {
                if (Misc.exclusiveRandom(1, 100) <= 10) {
                    player.getInventory().deleteItemSet(requirements);
                    player.getInventory().add(23221, 1);
                    player.sendMessage("@red@Congratulations, you've made the Blood Scythe Of Vitur!");
                    String msg = "@blu@<img=5>[CREATION]<img=5>@red@ " + player.getUsername() + " has created a Blood Scythe Of Vitur!";
                    World.sendMessage(msg);
                } else {
                    player.getInventory().delete(attachmentCost);
                    player.getInventory().delete(pvmCost);
        ...
        if (usedWith.getId() == 22106) {
            ...
            if (player.getInventory().containsAll(requirements) && itemUsedWith.getId() == 19_000) {
                ...
                return;
            } else if (player.getInventory().containsAll(
                    requirements = new Item[]{new Item(22106, 2),
                            new Item(18885, 1)})
                ...
                World.sendMessage(msg);
                return;
            } else if (player.getInventory().containsAll(requirements = new Item[]{
                    new Item(22106, 2), new Item(18887, 1),})
                    && itemUsedWith.getId() == requirements[1].getId()) {
                player.getInventory().deleteItemSet(requirements);
                ...
                World.sendMessage(msg);
                return;
            } else if (player.getInventory().containsAll(requirements =
                    new Item[]{new Item(22106, 3), new Item(4684, 1),})
                    && itemUsedWith.getId() == requirements[1].getId()) {
                player.getInventory().deleteItemSet(requirements);
                ...
                return;
                    ...
                    new Item[]{new Item(22106, 3), new Item(4685, 1),})
                    && itemUsedWith.getId() == requirements[1].getId()) {
                player.getInventory().deleteItemSet(requirements);
                ...
                return;
                    ...
                    new Item[]{new Item(22106, 3), new Item(4686, 1),})
                    && itemUsedWith.getId() == requirements[1].getId()) {
                player.getInventory().deleteItemSet(requirements);
                ...
                return;
                    ...
                    = new Item[]{new Item(22106, 3), new Item(20400, 1),})
                    && itemUsedWith.getId() == requirements[1].getId()) {
                player.getInventory().deleteItemSet(requirements);
    ...
    private static void itemOnObject(Player player, Packet packet) {
        ...
        int objectId1 = packet.readShort();
        ...
        player.setWalkToTask(new WalkToTask(player, gameObject.getPosition().copy(), gameObject.getSize(),
                new FinalizedMovementTask() {
                    ...
                    public void execute() {
                        ...
                        if (Prayer.isBone(itemId) && (objectId == 409 || objectId == 24343)) {
                        ...
                        switch (objectId) {
                            case 49921:
                                    if (player.getInventory().contains(itemId) && itemId >= 22100 && itemId <= 22105) {
                                        if (player.getSanctumRareDropBoost() >= DeathSanctumRewards.MAX) {
                                            player.sendMessage("@blu@You already reached the lowest drop rate possible.");
                                            return;
                                        }
                                        player.getInventory().delete(itemId, 1);
                                        player.setSanctumRareDropBoost(player.getSanctumRareDropBoost() + 1);
                                        player.sendMessage("@blu@Your rare drop table is now at 1/" + DeathSanctumRewards.getRareRate(player));


                                        DiscordMessager.sendSacrifice(player.getUsername() +
                                                        "==" +
                                                        "Sacrificed: x" + 1 + " " + ItemDefinition.forId(itemId).getName() + "(" + itemId + ")",
                                                Color.RED
                                        );
                                    } else {
                                        player.sendMessage("You can only sacrifice Lucifer pieces to the chest.");
                                    }
                                break;
                            case 29577:
                                    if (player.getInventory().contains(itemId) && itemId >= 23525 && itemId <= 23533) {
                                        if (player.getAnimaRareDropBoost() >= ChambersOfAnimaRewards.MAX - 1) {
                                            player.sendMessage("@blu@You already reached the lowest drop rate possible.");
                                            return;
                                        }
                                        player.getInventory().delete(itemId, 1);
                                        player.setAnimaRareDropBoost(player.getAnimaRareDropBoost() + 2);
                                        player.sendMessage("@blu@Your rare drop table is now at 1/" + ChambersOfAnimaRewards.getRareRate(player));
                                    ...
                                    } else if (player.getInventory().contains(itemId) && itemId >= 23465 && itemId <= 23473) {
                                        if (player.getAnimaRareDropBoost() >= ChambersOfAnimaRewards.MAX) {
                                            player.sendMessage("@blu@You already reached the lowest drop rate possible.");
                                            return;
                                        }
                                        player.getInventory().delete(itemId, 1);
                                        player.setAnimaRareDropBoost(player.getAnimaRareDropBoost() + 1);
                                        player.sendMessage("@blu@Your rare drop table is now at 1/" + ChambersOfAnimaRewards.getRareRate(player));
                                        ...
                                        player.sendMessage("You can only sacrifice SOD or SOD (u) pieces to the chest.");
                                    }
                                break;
                            case 172:
                            case 173:
    ...
    private static void itemOnNpc(final Player player, Packet packet) {
        ...
        if (npc.getId() == 10016)
            CelestialZone.useItem(player, id);
            ...
            case 23110:
                    if (!target.getInventory().isFull()) {
                        if (player.getInventory().contains(itemId)) {
                            ...
                            player.sendMessage("You need a Gold Season Pass to perform this action!");
                        }
                    } else {
                        player.sendMessage("This player's inventory is full.");
                    }
