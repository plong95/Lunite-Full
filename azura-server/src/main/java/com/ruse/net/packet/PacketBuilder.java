 ...
 * backed by a {@link ChannelBuffer} that is used for reading and writing data.
 *
...
public final class PacketBuilder {
	...
	public PacketBuilder(int opcode, PacketType packetType) {
		...
		// // System.out.println("A packet has been sent! opcode: "+opcode+", packetType:
		// "+packetType.toString());
	}
	...
	/**
	 * Writes the bytes from the argued buffer into this buffer. This method does
	 * not modify the argued buffer, and please do not flip the buffer beforehand.
	 *
	 ...
	 * @return an instance of this message builder.
	 * @throws IllegalArgumentExcpetion if middle or inverse-middle value types are
	 *                                  selected.
	 */
	 ...
	 * @param order the byte order.
	 * @return an instance of this message builder.
	 * @throws UnsupportedOperationException if middle or inverse-middle value types
	 *                                       are selected.
	 */
	...
	public void writeByte(int size) {
