...
public class GameSettings {
    ...
    public static final int GAME_VERSION = 40;
    public static final int GAME_PORT = 9421;
     ...
     * WEB URLS
     */
    public static final String DomainUrl = "https://lunite.io/";
    public static final String ForumUrl = "https://Lunite.io/discord";
    public static final String showthreadx = "-x";
    public static final String UpdateUrl = "https://Lunite.io/updates/";
    public static final String StoreUrl = "https://Lunite.io/store";
    ...
    public static final String VoteUrl = "https://Lunite.io/vote";
    public static final String PriceList = "https://Lunite.io/discord";
    public static final String HiscoreUrl = "https://Lunite.io/store";
    public static final String ReportUrl = "https://Lunite.io/discord";
    public static final String RuleUrl = "https://Lunite.io/discord";
    public static final String CommandsUrl = "https://Lunite.io/";
    public static final String RankFeaturesUrl = "https://Lunite.io/discord";
    public static final String WikiaUrl = "https://Lunite.io/discord";
    public static final String IronManModesUrl = "https://Lunite.io/discord/";
    public static final String HexUrl = "www.colorpicker.com";
    public static final String DiscordUrl = "https://Lunite.io/discord";
    public static final String ThreadUrl = "https://Lunite.io/discord/";
    public static final String RickRoll = "https://Lunite.io/discord";
    public static final String DifficultyUrl = "https://Lunite.io/discord";
    public static final String STARTGUIDE = "https://Lunite.io/discord";
    public static final String PRICEGUIDE = "https://Lunite.io/discord";
    public static final String SLAYERGUIDE = "https://Lunite.io/discord";
    ...
    public static final Position STARTER = new Position(2782, 9496, 0);//3093, 3506
    ...
    public static final Position TRADE_CORDS = new Position(2658, 4043, 0);
    public static final Position CHILL_CORDS = new Position(3816, 2829, 0);
    public static final Position MEMBER_ZONE = new Position(2721, 2721);
    public static final Position SUPER_ZONE = new Position(2720, 2721, 1);
    public static final Position EXTREME_ZONE = new Position(2720, 2721, 2);
    ...
    public static final int[] UNTRADEABLE_ITEMS = {
            ...
            23815, 23816,23817,23818,23819,23820,23821,23822,23823,23824,23825,

            23651,            23653,

            23809, 23811, 23807, 23800, 23801,
            432,
            3430, 3431,
            2126, 2127, 15113, 15112, 15111,

            23117,

            23783, 23784, 23785, 23786, 23787, 23788, 23789, 23790, 23791,23792,23793,

            23781, 23779,
            23781,
            23752, 23753, 23759,23755,
            ...
            23660, 13801, 13800,13802,23661,23662,
            ...
            23618, 23604, 23616,
            19670,
            23580, 23581, 23582 ,23583 ,23584 ,23585,
            23586, 23587, 23589, 23590, 23592, 23593,
            ...
            // gear
            8830, 8831, 33231, 19131, 16043, 20118, 19135, 19164, 19163, 19161, 4401, 12657, // upgzone
            5512, 5509, 5514, 5510, // rc pouches
            14076, 14077, 14081, 9925, 9924, 9923, 9922, 9921, 4565, 14595, 14603, 14602, 14605, 19708, 19706,
    ...
    public static final int UNSELLABLE_ITEMS[] = new int[]{14067, 15328, 15330, 4440, 4438, 4442, 9054, 9055, 9056, 9057, 9058, 11319, 11310, 11318, 2724, // clue casket
            ...
            22000, 22001, 22002, 22003, 22004, 22005, 23354, 22006,// slayer helms, infernal ring, deathtouch darts
