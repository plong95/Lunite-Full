 ...
 *
 * @param <E> the type of character being managed with this collection.
...
public final class CharacterList<E extends Character> implements Iterable<E> {
	...
	/**
	 * Searches through the backing array for the next available slot. This method
	 * will perform in constant time if the {@code removeSlots} list has a size
	 * greater than {@code 0}.
	 *
	 ...
	 * character list.
	 *
	 * @param <E> the type of character being iterated over.
	 * @author lare96 <http://github.com/lare96>
	 */
