...
public class PlayerSaving {
	...
	public static void save(Player player) {
		...
		try (FileWriter writer = new FileWriter(file)) {
			...
			//object.addProperty("title", player.getTitle());
			object.addProperty("player-title", player.getPlayerTitle().name());
			...
			object.add("progression-task-progress", builder.toJsonTree(player.getProgressionManager().getProgressions()));
			...
			object.addProperty("blood-odin-unlocked", player.isUnlockedBloodOdin());
			...
			if (player.getIronmanGroup() != null)
				object.addProperty("group-ironman-name", player.getIronmanGroup().getName());
			...
			object.addProperty("seasonpass-tier", player.getSeasonPass().getTier());
			object.addProperty("seasonpass-xp", player.getSeasonPass().getXp());
			object.addProperty("seasonpass-member", player.getSeasonPass().isMember());
			object.addProperty("seasonpass-season", player.getSeasonPass().getCurrentSeason());
			object.addProperty("seasonpass-received-500-kc-xp", player.getSeasonPass().isReceived500KCXP());

			object.add("turkeys-mutated", builder.toJsonTree(player.getTurkeysMutated()));

			object.addProperty("afk-caught", player.getAfkCombatChecker().getAfkCaught());

			object.addProperty("dissembler-charges", player.getDissemblerCharges());

			object.addProperty("last-voted", player.getLastVotedDay());
			object.addProperty("troll-day", player.getVotingMinigame().getDayCompleted());

			object.addProperty("sanctum-kc", player.getDeathSanctumKC());
			object.addProperty("sanctum-drop-rate", player.getSanctumRareDropBoost());
			object.addProperty("sanctum-key-opened", player.getSanctumKeysOpened());

			object.addProperty("cosmetic-override", player.isCosmeticOveride());
			object.addProperty("crest-creation", player.isLearnedCrestCreation());
			...
			object.addProperty("vday-love", player.getVDayEvent().getLove());
			object.addProperty("vday-hate", player.getVDayEvent().getHate());
			object.add("unlocked-love", builder.toJsonTree(player.getVDayEvent().getUnlockedLove()));
			object.add("unlocked-hate", builder.toJsonTree(player.getVDayEvent().getUnlockedHate()));
			object.addProperty("unlocked-crown", player.getVDayEvent().getUnlockedCrown());

			object.addProperty("hanto-dr", player.getHantoDR());
			...
			object.addProperty("received-shark-costume", player.isReceivedSharkCostume());
			...
			object.addProperty("sanctum-easy-timer", player.getSanctumEasyTimer());
			object.addProperty("sanctum-hard-timer", player.getSanctumHardTimer());
			...
			object.addProperty("assassin-tier", player.getAssassinsGuild().getTier());

			object.addProperty("deleted-billz", player.isDeletedBillz());
			object.addProperty("default-tped", player.isDefaultTeleporter());


			object.addProperty("sacrificed-owner", player.isSacrificedCelestialItem());
			object.addProperty("celestial", player.isCelestial());
			...
			object.addProperty("curse-of-arrav-progress", player.getCurseOfArrav().getQuestProgress());

			object.add("unlocked-titles", builder.toJsonTree(player.getTitlesManager().getObtainedTitles().toArray()));
			...
			object.addProperty("anima-kc", player.getAnimaChambersKC());
			object.addProperty("anima-drop-rate", player.getAnimaRareDropBoost());
			object.addProperty("anima-key-opened", player.getAnimaKeysOpened());
			object.addProperty("anima-easy-timer", player.getAnimaEasyTimer());
			object.addProperty("anima-hard-timer", player.getAnimaHardTimer());
