...
public class PlayerUpdating {
     ...
     * @param updateAppearance Update the player's appearance without the flag being
     *                         set?
    ...
    private static void updateSingleHit(PacketBuilder builder, Player target) {
        builder.putShort((int) target.getPrimaryHit().getDamage(), ValueType.A);
        builder.put(target.getPrimaryHit().getHitmask().ordinal());
        builder.put(target.getPrimaryHit().getCombatIcon().ordinal() - 1);
        builder.putShort((int) target.getPrimaryHit().getAbsorb(), ValueType.A);
        builder.putShort((int) target.getConstitution(), ValueType.A);
    ...
    private static void updateDoubleHit(PacketBuilder builder, Player target) {
        builder.putShort((int) target.getSecondaryHit().getDamage(), ValueType.A);
    ...
    private static void updateAppearance(Player player, PacketBuilder out, Player target) {
        ...
        if (player.getNpcTransformationId() <= 0) {
            ...
            int headSlot = Costumes.forID(equip[Equipment.COSTUME_SLOT]) != null && player.isCosmeticOveride() ? Costumes.getItem(equip[Equipment.COSTUME_SLOT], Equipment.HEAD_SLOT) : equip[Equipment.HEAD_SLOT];
            int bodySlot = Costumes.forID(equip[Equipment.COSTUME_SLOT]) != null && player.isCosmeticOveride()? Costumes.getItem(equip[Equipment.COSTUME_SLOT], Equipment.BODY_SLOT) : equip[Equipment.BODY_SLOT];
            int legsSlot = Costumes.forID(equip[Equipment.COSTUME_SLOT]) != null && player.isCosmeticOveride()? Costumes.getItem(equip[Equipment.COSTUME_SLOT], Equipment.LEG_SLOT) : equip[Equipment.LEG_SLOT];
            int glovesSlot = Costumes.forID(equip[Equipment.COSTUME_SLOT]) != null && player.isCosmeticOveride()? Costumes.getItem(equip[Equipment.COSTUME_SLOT], Equipment.HANDS_SLOT) : equip[Equipment.HANDS_SLOT];
            int bootsSlot =Costumes.forID(equip[Equipment.COSTUME_SLOT]) != null && player.isCosmeticOveride()? Costumes.getItem(equip[Equipment.COSTUME_SLOT], Equipment.FEET_SLOT) :  equip[Equipment.FEET_SLOT];
            ...
            if (equip[Equipment.CAPE_SLOT] > -1 && ((player.isRenderPlayerEquipment() && !target.equals(player) )|| target.equals(player))) {
            ...
            if (equip[Equipment.AMULET_SLOT] > -1 && ((player.isRenderPlayerEquipment() && !target.equals(player) )|| target.equals(player))) {
            ...
            if (bodySlot > -1 && ((player.isRenderPlayerEquipment() && !target.equals(player) )|| target.equals(player))) {
                properties.putShort(0x200 + bodySlot);
            } else {
                properties.putShort(0x100 + appearance.getLook()[Appearance.CHEST]);
            }

            if (equip[Equipment.SHIELD_SLOT] > -1 && ((player.isRenderPlayerEquipment() && !target.equals(player) )|| target.equals(player))) {
            ...
            if (appearance.getLook()[Appearance.BEARD] <= 0 || appearance.getGender().equals(Gender.FEMALE)) {
                properties.put(0);
            } else if (ItemDefinition.forId(headSlot).isFullHelm() && ((player.isRenderPlayerEquipment() && !target.equals(player) )|| target.equals(player))) {
                properties.put(0);
            } else {
            ...
            if (equip[Equipment.AURA_SLOT] > -1 && ((player.isRenderPlayerEquipment() && !target.equals(player) )|| target.equals(player))) {
        ...
        properties.putShort(target.getGameMode().ordinal());
