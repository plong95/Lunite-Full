...
public class WoodcuttingData {
	...
	public static enum Hatchet {
		BRONZE(1351, 1, 879, 1.0), IRON(1349, 1, 877, 1.3), STEEL(1353, 6, 875, 1.5), BLACK(1361, 6, 873, 1.7),
		MITHRIL(1355, 21, 871, 1.9), ADAMANT(1357, 31, 869, 2), RUNE(1359, 41, 867, 2.2), ADZE(13661, 61, 406, 2.33), // old
																														// anim
																														// =
																														// 10227
		DRAGON(6739, 61, 2846, 2.5),
		SACRED(14140, 61, 406, 2.5),
		UNIVERSAL(19753, 61, 407, 4),
		CRYSTAL(23886, 99, 407, 4);
	...
	public static enum Trees {
		NORMAL(1, 25, 1511,
				new int[] { 1276, 1277, 1278, 1279, 1280, 1282, 1283, 1284, 1285, 1286, 1289, 1290, 1291, 1315, 1316,
						...
						5903, 5904 },
				4, false),
		ACHEY(1, 25, 2862, new int[] { 2023 }, 4, false), OAK(15, 38, 1521, new int[] { 1281, 3037 }, 5, true),
