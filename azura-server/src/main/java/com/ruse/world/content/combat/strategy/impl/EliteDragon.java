...
public class EliteDragon implements CombatStrategy {
	...
	public boolean customContainerAttack(Character entity, Character victim) {
		...
		if (victim == null || player == null || victim.getConstitution() <= 0 || entity == null
				|| entity.getConstitution() <= 0 || dragon == null) {
			return true;
		}
		if (!victim.getCombatBuilder().getLastAttack().elapsed(2000) && victim.getCombatBuilder().getVictim() != null
