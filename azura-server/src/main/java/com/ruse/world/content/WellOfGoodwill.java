...
public class WellOfGoodwill {
	...
	public static void donate(Player player, int amount) {
		...
		AchievementsOLD.finishAchievement(player, AchievementDataOLD.FILL_WELL_OF_GOODWILL_1M);
		AchievementsOLD.doProgress(player, AchievementDataOLD.FILL_WELL_OF_GOODWILL_50M, amount);
		AchievementsOLD.doProgress(player, AchievementDataOLD.FILL_WELL_OF_GOODWILL_250M, amount);
