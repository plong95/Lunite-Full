...
public class MiningData {
	...
	public static final int[] RANDOM_GEMS = { 17634 };
	...
	public static enum Ores {
		Rune_essence(new int[] { 24444 }, 1, 10, 1436, 2, -1), Pure_essence(new int[] { 24445 }, 17, 25, 7936, 3, -1),
		// AFKMINE(new int[]{24445}, 17, 25, 7936, 3, -1),
		Clay(new int[] { 9711, 9712, 9713, 15503, 15504, 15505 }, 1, 5, 434, 3, 2),
		Copper(new int[] { 3042, 9708, 9709, 9710, 11936, 11960, 11961, 11962, 11189, 11190, 11191, 29231, 29230,
				2090 }, 1, 18, 436, 4, 4),
		Tin(new int[] { 3043, 9714, 9715, 9716, 11933, 11957, 11958, 11959, 11186, 11187, 11188, 2094, 29227, 29229 },
				1, 18, 438, 4, 4),
		Iron(new int[] { 9717, 9718, 9719, 2093, 2092, 11954, 11955, 11956, 29221, 29222, 29223,37307 }, 15, 35, 440, 5, 5),
		Silver(new int[] { 2100, 2101, 29226, 29225, 11948, 11949,37304}, 20, 40, 442, 5, 7),
		Coal(new int[] { 2097, 5770, 29216, 29215, 29217, 11965, 11964, 11963, 11930, 11931, 11932 }, 30, 50, 453, 5,
				7),
		Gold(new int[] { 9720, 9721, 9722, 11951, 11183, 11184, 11185, 2099,37310 }, 40, 65, 444, 5, 10),
		Mithril(new int[] { 25370, 25368, 5786, 5784, 11942, 11943, 11944, 11945, 11946, 29236, 11947, 11942, 11943 },
				50, 80, 447, 6, 11),
		...
		CELESTIAL(new int[] { 37689 }, 1, 100, 23748, 6, -1),
