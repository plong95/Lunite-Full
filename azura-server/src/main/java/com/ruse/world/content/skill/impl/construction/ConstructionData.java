...
/**
 * 
 * @author Owner Blade Edited by Gabbe, fixed all wrong requirements etc
 */
public class ConstructionData {

	public static final int EMPTY = 0, BUILDABLE = 1, GARDEN = 2, PARLOUR = 3, KITCHEN = 4, DINING_ROOM = 5,
			WORKSHOP = 6, BEDROOM = 7, SKILL_ROOM = 8, QUEST_HALL_DOWN = 9, GAMES_ROOM = 10, COMBAT_ROOM = 11,
			QUEST_ROOM = 12, MENAGERY = 13, STUDY = 14, COSTUME_ROOM = 15, CHAPEL = 16, PORTAL_ROOM = 17,
			FORMAL_GARDEN = 18, THRONE_ROOM = 19, OUBLIETTE = 20, PIT = 21, DUNGEON_STAIR_ROOM = 22, TREASURE_ROOM = 23,
			CORRIDOR = 24, JUNCTION = 25, SKILL_HALL_DOWN = 26, ROOF = 27, DUNGEON_EMPTY = 28,
	...
	public static enum Portals {
		VARROCK(1, new Position(ConstructionConstants.VARROCK_X, ConstructionConstants.VARROCK_Y), 25,
				new int[][] { { 563, 100 }, { 554, 100/* fire */ }, { 556, 300 /* Air */ } },
				new int[] { 13615, 13622, 13629 }),
		...
		public String canBuild(Player p) {
			if (requiredItems == null) {
				...
				if (!found) {
					...
					// p.getPacketSender().sendObjectsRemoval(myTiles[0]-1, myTiles[1]-1,
					// p.inConstructionDungeon() ? 4 : p.getPosition().getZ());
					// Construction.placeAllFurniture(p, myTiles[0]-1, myTiles[1]-1,
					// p.inConstructionDungeon() ? 4 : p.getPosition().getZ());
					p.getPacketSender().sendInterfaceRemoval();
					return null;
				}
	...
	public static enum Butlers {
		JACK(4235, 20, 500, 6, 60), MAID(4237, 25, 1000, 10, 30), COOK(4239, 30, 3000, 16, 17),
		BUTLER(4241, 40, 5000, 20, 12), DEMON_BUTLER(4243, 50, 10000, 26, 7),;
	...
	public static final String[] HANGMANWORDS = new String[] { "DENNISISNOOB", "ABYSSAL", "ADAMANTITE", "ALKHARID",
			"ARDOUGNE", "ASGARNIA", "AVANTOE", "BASILISK", "BANSHEE", "BARROWS", "BLOODVELD", "BOBTHECAT", "BRIMHAVEN",
			"BURTHORPE", "CADANTINE", "CAMELOT", "CANIFIS", "CATHERBY", "CHAOSDRUID", "CHAOSDWARF", "CHOMPYBIRD",
			"COCKATRICE", "CRANDOR", "CROMADIURE", "DAGANNOTH", "DORGESHUUN", "DRAGON", "DRAYNOR", "DUSTDEVIL",
			"DWARFWEED", "EDGEVILLE", "ENTRANA", "FALADOR", "FELDIP", "FIREGIANT", "FREMENNIK", "GARGOYLE", "GOBLIN",
			"GRANDTREE", "GUAMLEAF", "GUTANOTH", "GUTHIX", "HILLGIANT", "HELLHOUND", "HIGHWAYMAN", "HOBGOBLIN",
			"ICEGIANT", "ICEQUEEN", "ICEWARRIOR", "ICEWOLF", "ICETROLL", "IRITLEAF", "ISAFDAR", "JOGRE", "KALPHITE",
			"KANDARIN", "KARAMJA", "KELDAGRIM", "KHAZARD", "KWUARM", "LANTADYME", "LLETYA", "LUMBRIDGE", "NECHRYAEL",
			"MARRENTILL", "MENAPHOS", "MISTHALIN", "MITHRIL", "MOGRE", "MORTTON", "MORYTANIA", "MOSSGIANT",
			"NIGHTSHADE", "PALADIN", "PHASMATYS", "PORTSARIM", "PRIFDDINAS", "PYREFIEND", "RANARRWEED", "RELLEKKA",
			"RIMMINGTON", "RUNESCAPE", "RUNITE", "SARADOMIN", "SKELETON", "SNAPDRAGON", "SNAPEGRASS", "SOPHANEM",
			"SOULLESS", "SPIRITTREE", "TARROMIN", "TAVERLEY", "TERRORBIRD", "TIRANNWN", "TOADFLAX", "TORSTOL",
			"UGTHANKI", "UNICORN", "VARROCK", "WHIP", "YANILLE", "ZAMORAK" };
	...
	public enum RoomData {
		...
		DUNGEON_STAIR_ROOM(1872, 5080, ConstructionData.DUNGEON_STAIR_ROOM, 70, 7500,
				new boolean[] { true, true, true, true }),
		TREASURE_ROOM(1912, 5088, ConstructionData.TREASURE_ROOM, 75, 250000,
		...
		private RoomData(int x, int y, int id, int levelToBuild, int cost, boolean[] doors) {
			this.x = x;
			this.y = y;
			this.id = id;
	...
	public static boolean isDungeonRoom(int roomType) {
		return roomType == DUNGEON_STAIR_ROOM || roomType == CORRIDOR || roomType == JUNCTION || roomType == OUBLIETTE
				|| roomType == PIT || roomType == TREASURE_ROOM;
	}
	...
	public enum HotSpots {
		 ...
		 * Garden
		 */
		CENTREPIECE(0, 15361, 3, 3, 0, ConstructionData.GARDEN), TREE_1(1, 15362, 1, 5, 0, ConstructionData.GARDEN),
		TREE_2(1, 15363, 6, 6, 0, ConstructionData.GARDEN), SMALL_PLANT_1(2, 15366, 3, 1, 0, ConstructionData.GARDEN),
		 ...
		 * Pit
		 */
		PIT_TRAP_1(93, 39230, 3, 1, 0, ConstructionData.PIT), PIT_TRAP_2(93, 39231, 5, 3, 3, ConstructionData.PIT),
		PIT_TRAP_3(93, 36692, 3, 5, 2, ConstructionData.PIT), PIT_TRAP_4(93, 39229, 1, 3, 1, ConstructionData.PIT),
		...
		private HotSpots(int hotSpotId, int objectId, int xOffset, int yOffset, int standardRotation, int roomType) {
		...
		private HotSpots(int hotSpotId, int objectId, int xOffset, int yOffset, int standardRotation, int roomType,
				int objectType, boolean mutiple) {
		...
		private HotSpots(int hotSpotId, int objectId, int xOffset, int yOffset, int standardRotation, int roomType,
				int objectType, Dimension carpetDim) {
			this(hotSpotId, objectId, xOffset, yOffset, standardRotation, roomType, objectType);
	...
	public static int getXOffsetForObjectId(int objectId, int hsId, int rotation) {
		...
		int finalXTile = 0 + getRotatedLandscapeChunkX(rotation, objectDef.getSizeY(), hs.xOffset, hs.yOffset,
	...
	public static int getYOffsetForObjectId(int objectId, int hsId, int rotation) {
		...
		if (hs == null)
			return 0;
		GameObjectDefinition objectDef = GameObjectDefinition.forId(objectId);
		int finalYTile = 0 + getRotatedLandscapeChunkY(hs.yOffset, objectDef.getSizeY(), rotation, objectDef.getSizeX(),
				hs.xOffset, hs.getRotation(0));
		return finalYTile;
	}

	public static int getYOffsetForObjectId(int objectId, int offsetX, int offsetY, int rotation, int objectRot) {
		GameObjectDefinition objectDef = GameObjectDefinition.forId(objectId);
		int finalYTile = 0 + getRotatedLandscapeChunkY(offsetY, objectDef.getSizeY(), rotation, objectDef.getSizeX(),
				offsetX, objectRot);
		return finalYTile;
	}
	...
	public static int getXOffsetForObjectId(int objectId, int offsetX, int offsetY, int rotation, int objectRot) {
		GameObjectDefinition objectDef = GameObjectDefinition.forId(objectId);
		int finalXTile = 0 + getRotatedLandscapeChunkX(rotation, objectDef.getSizeY(), offsetX, offsetY,
	...
	public static int getXOffsetForObjectId(int objectId, HotSpots hs, int rotation) {
		GameObjectDefinition objectDef = GameObjectDefinition.forId(objectId);
		int finalXTile = 0 + getRotatedLandscapeChunkX(rotation, objectDef.getSizeY(), hs.getXOffset(), hs.getYOffset(),
				objectDef.getSizeX(), hs.getRotation(0));
		return finalXTile;
	}
	...
	public static int getYOffsetForObjectId(int objectId, HotSpots hs, int rotation) {
		GameObjectDefinition objectDef = GameObjectDefinition.forId(objectId);
		int finalYTile = 0 + getRotatedLandscapeChunkY(hs.getYOffset(), objectDef.getSizeY(), rotation,
				objectDef.getSizeX(), hs.getXOffset(), hs.getRotation(0));
		return finalYTile;
	}

	public enum Furniture {
		EMPTY(-1, 6951, 0, 0, 0, null), EXIT_PORTAL(0, 13405, 100, 1, 8168, new int[][] { { IRON_BAR, 10 } }),
		...
		CIDER_BARREL(13, 13569, 91, 12, 8240, new int[][] { { PLANK, 3 }, { NAILS, 3 }, { 5763, 8 } },
				new int[][] { { 7, 14 } }),
		ASGARNIAN_ALE_BARREL(13, 13570, 184, 14, 8241, new int[][] { { OAK_PLANK, 3 }, { 1905, 8 } },
				new int[][] { { 7, 24 } }),
		GREENMANS_ALE_BARREL(13, 13571, 184, 26, 8242, new int[][] { { OAK_PLANK, 3 }, { 1909, 8 } },
				new int[][] { { 7, 29 } }),
		DRAGON_BITTER_BARREL(13, 13572, 224, 36, 8243, new int[][] { { OAK_PLANK, 3 }, { STEEL_BAR, 2 }, { 1911, 8 } },
				new int[][] { { 7, 39 } }),
		CHEFS_DELIGHT_BARREL(13, 13573, 224, 48, 8244, new int[][] { { OAK_PLANK, 3 }, { STEEL_BAR, 2 }, { 5755, 8 } },
				new int[][] { { 7, 54 } }),
		...
		OPULENT_TABLE(21, 13299, 3100, 72, 8121,
				new int[][] { { MAHOGANY_PLANK, 6 }, { CLOTH, 4 }, { GOLD_LEAF, 4 }, { MARBLE_BLOCK, 2 } }),
		/**
		 * Workshop
		 */
		...
		GILDED_DRESSER(27, 13168, 582, 74, 8051,
				new int[][] { { MAHOGANY_PLANK, 2 }, { MOLTEN_GLASS, 2 }, { GOLD_LEAF, 1 } }),
		...
		GILDED_FOUR_POSTER(28, 13154, 1330, 60, 8037,
				new int[][] { { MAHOGANY_PLANK, 5 }, { CLOTH, 2 }, { GOLD_LEAF, 2 } }),
		...
		GILDED_CLOCK(30, 13171, 602, 85, 8054,
				new int[][] { { MAHOGANY_PLANK, 2 }, { CLOCKWORK, 1 }, { GOLD_LEAF, 1 } }),

		RUNE_CASE_1(31, 13507, 190, 41, 8276, new int[][] { { TEAK_PLANK, 2 }, { MOLTEN_GLASS, 2 } },
				new int[][] { { 20, 14 } }),
		RUNE_CASE_2(31, 13508, 212, 41, 8277, new int[][] { { TEAK_PLANK, 2 }, { MOLTEN_GLASS, 2 } },
				new int[][] { { 20, 44 } }),
		...
		KING_BLACK_DRAGON_HEAD(33, 13486, 1103, 78, 8265,
				new int[][] { { MAHOGANY_PLANK, 2 }, { 7987, 1 }, { GOLD_LEAF, 2 } }),
		KALPHITE_QUEEN_HEAD(33, 13487, 1103, 78, 8266,
				new int[][] { { MAHOGANY_PLANK, 2 }, { 7988, 1 }, { GOLD_LEAF, 2 } }),

		MITHRIL_ARMOUR(34, 13491, 135, 28, 8270, new int[][] { { 1159, 1 }, { 1121, 1 }, { 1085, 1 } },
				new int[][] { { 13, 68 } }),
		ADAMANT_ARMOUR(34, 13492, 150, 28, 8271, new int[][] { { 1161, 1 }, { 1123, 1 }, { 1087, 1 } },
				new int[][] { { 13, 88 } }),
		RUNE_ARMOUR(34, 13493, 165, 28, 8272, new int[][] { { 1163, 1 }, { 1125, 1 }, { 1089, 1 } },
				new int[][] { { 13, 99 } }),

		BASIC_DECORATIVE_ARMOUR_STAND(35, 13495, 135, 28, 8273, new int[][] { { 4071, 1 }, { 4072, 1 }, { 4069, 1 } }),
		DETAILED_DECORATIVE_ARMOUR_STAND(35, 13496, 150, 28, 8274,
				new int[][] { { 4506, 1 }, { 4507, 1 }, { 4504, 1 } }),
		INTRICATE_DECORATIVE_ARMOUR_STAND(35, 13497, 165, 28, 8275,
				new int[][] { { 4511, 1 }, { 4512, 1 }, { 4509, 1 } }),
		PROFOUND_DECORATIVE_ARMOUR_STAND(35, 34281, 180, 28, 18755,
				new int[][] { { 18708, 1 }, { 18709, 1 }, { 18706, 1 } }),
		...
		ELEMENTAL_BALANCE_1(40, 13395, 179, 37, 8156,
				new int[][] { { AIR_RUNE, 500 }, { EARTH_RUNE, 500 }, { WATER_RUNE, 500 }, { FIRE_RUNE, 500 } }),
		ELEMENTAL_BALANCE_2(40, 13396, 252, 57, 8157,
				new int[][] { { AIR_RUNE, 1000 }, { EARTH_RUNE, 1000 }, { WATER_RUNE, 1000 }, { FIRE_RUNE, 1000 } }),
		ELEMENTAL_BALANCE_3(40, 13397, 356, 77, 8158,
				new int[][] { { AIR_RUNE, 2000 }, { EARTH_RUNE, 2000 }, { WATER_RUNE, 2000 }, { FIRE_RUNE, 2000 } }),
		...
		BALANCE_BEAM(44, 13142, 1000, 81, 8027, new int[][] { { TEAK_PLANK, 10 }, { STEEL_BAR, 5 } }), // ground dec
																										// type (22)
		...
		ARMILLARY_GLOBE(58, 13653, 960, 77, 8345,
				new int[][] { { MAHOGANY_PLANK, 2 }, { GOLD_LEAF, 2 }, { STEEL_BAR, 4 } }),
		...
		LIMESTONE_ALTAR(69, 13191, 910, 64, 8066,
				new int[][] { { MAHOGANY_PLANK, 4 }, { CLOTH, 2 }, { LIMESTONE_BRICK, 2 } }),
		...
		GILDED_THRONE(79, 13668, 1700, 81, 8360,
				new int[][] { { MAHOGANY_PLANK, 10 }, { MARBLE_BLOCK, 3 }, { GOLD_LEAF, 3 } }),
		SKELETON_THRONE(79, 13669, 7003, 88, 8361,
				new int[][] { { OAK_PLANK, 10 }, { MARBLE_BLOCK, 2 }, { BONES, 5 }, { SKULLS, 2 } }),
		...
		private Furniture(int hotspotId, int furnitureId, int xp, int level, int itemId, int[][] requiredItems) {
			this.hotspotId = hotspotId;
	...
	public static final int LIT_CANDLE = 34, PLANK = 960, OAK_PLANK = 8778, TEAK_PLANK = 8780, MAHOGANY_PLANK = 8782,
			GOLD_LEAF = 8784, MARBLE_BLOCK = 8786, MAGIC_STONE = 8788, CLOTH = 8790, CLOCKWORK = 8792, SAW = 8794,
			NAILS = 1539, MOLTEN_GLASS = 1775, SOFT_CLAY = 1761, LIMESTONE_BRICK = 3420, STEEL_BAR = 2353,
			IRON_BAR = 2351, ROPE = 954, AIR_RUNE = 556, WATER_RUNE = 555, EARTH_RUNE = 557, FIRE_RUNE = 554,
			BSF = 8457, WATER_CAN = 5331, BM = 8459, BR = 8461, BRM = 8451, BD = 8453, BBB = 8455, BTH = 8437,
			BNH = 8439, SBH = 8441, TH = 8443, FH = 8445, TFH = 8447, TBH = 8449, BONES = 526, SKULLS = 964, COIN = 995,
			BOW = 1929, RD = 1763;

	/*
	 * Bagged sunflower = bsf Bagged marrigolds = BM Bagged roses = BR Bagged
	 * rosemary = BRM Bagged daffodiles = BD Bagged bluebells = BBB Bagged thorny
	 * hedge = BTH Bagged nice hedge = BNH Bagged small boxed hedge = SBH Bagged
	 * toparry hedge = TH Bagged Fancy hedge = FH Bagged Tall fancy Hedge = TFH
	 * Bagged Tall Box hedge = TBH <- win? xD Bucket of water = BOW
	 */
