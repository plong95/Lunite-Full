...
public class Emotes {
	...
	public enum EmoteData {
		YES(168, new Animation(855), null), NO(169, new Animation(856), null), BOW(164, new Animation(858), null),
		ANGRY(165, new Animation(859), null), THINK(162, new Animation(857), null), WAVE(163, new Animation(863), null),
		SHRUG(13370, new Animation(2113), null), CHEER(171, new Animation(862), null),
		BECKON(167, new Animation(864), null), LAUGH(170, new Animation(861), null),
		JUMP_FOR_JOY(13366, new Animation(2109), null), YAWN(13368, new Animation(2111), null),
		DANCE(166, new Animation(866), null), JIG(13363, new Animation(2106), null),
		SPIN(13364, new Animation(2107), null), HEADBANG(13365, new Animation(2108), null),
		CRY(161, new Animation(860), null), KISS(11100, new Animation(1374), new Graphic(1702)),
		PANIC(13362, new Animation(2105), null), RASPBERRY(13367, new Animation(2110), null),
		CRAP(172, new Animation(865), null), SALUTE(13369, new Animation(2112), null),
		GOBLIN_BOW(13383, new Animation(2127), null), GOBLIN_SALUTE(13384, new Animation(2128), null),
		GLASS_BOX(667, new Animation(1131), null), CLIMB_ROPE(6503, new Animation(1130), null),
		LEAN(6506, new Animation(1129), null), GLASS_WALL(666, new Animation(1128), null),
		ZOMBIE_WALK(18464, new Animation(3544), null), ZOMBIE_DANCE(18465, new Animation(3543), null),
		SCARED(15166, new Animation(2836), null), RABBIT_HOP(18686, new Animation(6111), null),

		/*
		 * ZOMBIE_HAND(15166, new Animation(7272), new Graphic(1244)),
		 * SAFETY_FIRST(6540, new Animation(8770), new Graphic(1553)), AIR_GUITAR(11101,
		 * new Animation(2414), new Graphic(1537)), SNOWMAN_DANCE(11102, new
		 * Animation(7531), null), FREEZE(11103, new Animation(11044), new
		 * Graphic(1973))
		 */;
	...
	public static boolean doEmote(final Player player, int buttonId) {
		...
		if (emoteData != null) {
			...
			if (data != null) {
				...
				if (data != Skillcape_Data.PVP && data != Skillcape_Data.DUNGEONEERING_MASTER) {
					...
					TaskManager.submit(new Task(1, player, true) {
						...
						protected void execute() {
							...
							case 11:
								...
								break;
							/*
							 * case 10: ranger looks fucked player.setNpcTransformationId(11229);
							 * player.getUpdateFlag().flag(Flag.APPEARANCE); player.performAnimation(new
							 * Animation(13194)); break; case 14: player.setNpcTransformationId(-1);
							 * player.getUpdateFlag().flag(Flag.APPEARANCE);
							 * player.getPacketSender().sendAnimationReset();
							 * player.getMovementQueue().setLockMovement(lock); stop(); break;
							 */
							}
							tick++;
						}
	...
	private enum Skillcape_Data {
		ATTACK(new int[] { 9747, 9748, 10639 }, 4959, 823, 7), DEFENCE(new int[] { 9753, 9754, 10641 }, 4961, 824, 10),
		STRENGTH(new int[] { 9750, 9751, 10640 }, 4981, 828, 25),
		CONSTITUTION(new int[] { 9768, 9769, 10647 }, 14242, 2745, 12),
		RANGED(new int[] { 9756, 9757, 10642 }, 4973, 832, 12), PRAYER(new int[] { 9759, 9760, 10643 }, 4979, 829, 15),
		MAGIC(new int[] { 9762, 9763, 10644 }, 4939, 813, 6), COOKING(new int[] { 9801, 9802, 10658 }, 4955, 821, 36),
		WOODCUTTING(new int[] { 9807, 9808, 10660 }, 4957, 822, 25),
		FLETCHING(new int[] { 9783, 9784, 10652 }, 4937, 0, 20),
		...
		SMITHING(new int[] { 9795, 9796, 10656 }, 4943, 815, 23), MINING(new int[] { 9792, 9793, 10655 }, 4941, 814, 8),
