...
public class CombatRangedAmmo {
	...
	public enum RangedWeaponData {
		...
		MAGIC_LONGBOW(new int[] { 859 },
				...
				RangedWeaponType.LONGBOW),
		MAGIC_SHORTBOW(new int[] { 861, 6724 },
				new AmmunitionData[] { AmmunitionData.BRONZE_ARROW, AmmunitionData.IRON_ARROW,
						AmmunitionData.STEEL_ARROW, AmmunitionData.MITHRIL_ARROW, AmmunitionData.ADAMANT_ARROW,
						AmmunitionData.RUNE_ARROW, AmmunitionData.ICE_ARROW, AmmunitionData.BROAD_ARROW },
				RangedWeaponType.SHORTBOW),
		...
		ARMADYL_CROSSBOW(new int[] { 22034, 18799, 18358 },
		...
		GINREI_KOJAKU(new int[] { 22010, 16337, 21018,21053,21054,21055,21056 }, new AmmunitionData[] { AmmunitionData.ZARYTE_AMMO },
				RangedWeaponType.BSOAT),
		AOEWEAPONS(new int[] {3738 }, new AmmunitionData[] { AmmunitionData.AOE_AMMO },
				RangedWeaponType.BSOAT),
		MINIGUN(new int[] { 19137, 23710, 19136, 19843, 9941, 5012, 18636,8088,5073,8411,23785, 5011,22113, 23455, 23455, 23474, 23568, 23716,
				23817, 23222, 23642, 23841, 23643, 5010,8001,21606,15785,14919, 8253, 23832, 23891,23839, 22089,7543,9929,14056, 20173, 671, 16879,18332, 20553, 22083 },
		...
		ADAMANT_CROSSBOW(new int[] { 9183 },
				new AmmunitionData[] { AmmunitionData.BRONZE_BOLT, AmmunitionData.OPAL_BOLT, AmmunitionData.IRON_BOLT,
						...
						AmmunitionData.SAPPHIRE_BOLT, AmmunitionData.EMERALD_BOLT, AmmunitionData.RUBY_BOLT },
				RangedWeaponType.CROSSBOW),
		/* Crossbows who accept all ammo */HIGHEST_CROSSBOWS(new int[] { 9185, 18357, 14684 },
				new AmmunitionData[] { AmmunitionData.BRONZE_BOLT, AmmunitionData.OPAL_BOLT, AmmunitionData.IRON_BOLT,
						AmmunitionData.JADE_BOLT, AmmunitionData.STEEL_BOLT, AmmunitionData.PEARL_BOLT,
						AmmunitionData.MITHRIL_BOLT, AmmunitionData.TOPAZ_BOLT, AmmunitionData.ADAMANT_BOLT,
						AmmunitionData.SAPPHIRE_BOLT, AmmunitionData.EMERALD_BOLT, AmmunitionData.RUBY_BOLT,
		...
		DEATH_DART(new int[] { 22006 }, new AmmunitionData[] { AmmunitionData.DEATH_TOUCH },
				RangedWeaponType.THROW),

		TOXIC_BLOWPIPE(new int[] { 12926 },
				new AmmunitionData[] { AmmunitionData.BRONZE_DART, AmmunitionData.IRON_DART, AmmunitionData.STEEL_DART,
						AmmunitionData.MITHRIL_DART, AmmunitionData.ADAMANT_DART, AmmunitionData.RUNE_DART,
						AmmunitionData.DRAGON_DART },
		...
		MORRIGANS_JAVELIN(new int[] { 13879, 13956, 13953 }, new AmmunitionData[] { AmmunitionData.MORRIGANS_JAVELIN },
				RangedWeaponType.THROW),
		...
		HAND_CANNON(new int[] { 15241, 19135 }, new AmmunitionData[] { AmmunitionData.HAND_CANNON_SHOT },
				RangedWeaponType.HAND_CANNON),

		KARILS_CROSSBOW(new int[] { 4734 }, new AmmunitionData[] { AmmunitionData.BOLT_RACK },
				RangedWeaponType.CROSSBOW);

		// TOXIC_BLOWPIPE(new int[]{12926}, new AmmunitionData[]
		// {AmmunitionData.ZULRAH_SCALES}, RangedWeaponType.BLOWPIPE);
	...
	public enum AmmunitionData {
		// AmnitionData(int[] itemIds, int startGfxId, int projectileId, int
		// projectileSpeed, int projectileDelay, int strength, int startHeight, int
		// endHeight) {
		// ENERGY(new int[] {-1}, 250, 249, 1, 33, 400, 43, 31),
		ZARYTE_AMMO(new int[] { 78 }, 250, 249, 3, 44, 200, 43, 31),
		AOE_AMMO(new int[] { 78 }, 250, 249, 3, 44, 1000, 43, 31),
		CANNON_AMMO(new int[] { -1 }, -1, 2143, 3, 44, 200, 43, 31),
		...
		MORRIGANS_JAVELIN(new int[] { 13879, 13956, 13953 }, 1855, -1, 2, 40, 100, 45, 37),
		...
		HAND_CANNON_SHOT(new int[] { 15243 }, -1, 2143, 3, 8, 115, 43, 31),
	...
	public enum RangedWeaponType {
		...
		LONGBOW(5, 5), SHORTBOW(5, 4), CROSSBOW(5, 5), ARMADYLXBOW(5, 5), THROW(4, 3), DARK_BOW(5, 5),
		HAND_CANNON(5, 4), BLOWPIPE(4, 3), BSOAT(8, 1);
