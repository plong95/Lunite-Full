...
public class MinigameAttributes {
	...
	@Getter
	private final DeathSanctumAttributes deathSanctumAttributes = new DeathSanctumAttributes();

	@Getter
	private final AnimaChamberAttributes animaChamberAttributes = new AnimaChamberAttributes();

	private final HallsOfValorAttributes hallsOfValorAttributes = new HallsOfValorAttributes();
	public HallsOfValorAttributes getHallsOfValorAttributes() {
		return hallsOfValorAttributes;
	}
	public class HallsOfValorAttributes {
	...
	@Getter
	@Setter
	public class DeathSanctumAttributes {
		private DeathSanctumParty party;
		private DeathSanctumParty invitation;
		private long lastInvitation;
		private int points;
		private int deaths;
	}
	...
	@Getter
	@Setter
	public class AnimaChamberAttributes {
		private ChambersOfAnimaParty party;
		private ChambersOfAnimaParty invitation;
		private long lastInvitation;
		private int points;
		private int deaths;
	}
