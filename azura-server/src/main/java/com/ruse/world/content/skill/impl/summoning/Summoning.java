...
//			return;
        ...
        TaskManager.submit(new Task(1, false) {
            ...
            protected void execute() {
                ...
                if (bossPet == BossPet.ADMINPET || bossPet == BossPet.VOTEPET|| bossPet == BossPet.DBZ)
    ...
    public void moveFollower(boolean forced) {
        if (getFamiliar() != null && getFamiliar().getSummonNpc() != null) {
            final Position movePos = new Position(player.getPosition().getX(), player.getPosition().getY() + 1,
