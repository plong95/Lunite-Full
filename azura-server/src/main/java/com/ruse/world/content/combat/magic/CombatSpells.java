...
public enum CombatSpells {
	...
	WIND_STRIKE(new CombatNormalSpell() {
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 606, 44, 3, 43, 31, 0));
		}
		...
		@Override
		public int maximumHit() {
			return 900; // x10 hits - change later
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 197, 44, 3, 43, 31, 0));
		}
		...
		@Override
		public int maximumHit() {
			return 9000; // x10 hits - change later
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 78, 78, 3, 20, 30, 0));
		}
		...
		@Override
		public int maximumHit() {
			return 15650; // x10 hits - change later
		}
	...
	}), AVERNICBLAST(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(1979));
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 1339, 44, 3, 43, 31, 0));
		}
		...
		@Override
		public int maximumHit() {
			return 200; // x10 hits - change later
		}
...
SORCEBLAST(new CombatNormalSpell() {
	@Override
	public Optional<Animation> castAnimation() {
		return Optional.of(new Animation(1979));
	}
	...
	@Override
	public Optional<Projectile> castProjectile(Character cast, Character castOn) {
		return Optional.of(new Projectile(cast, castOn, 1854, 44, 3, 43, 31, 0));
	}
	...
	@Override
	public int maximumHit() {
		return 1000; // x10 hits - change later
	}
...
ICEYBLAST(new CombatNormalSpell() {
	@Override
	public Optional<Animation> castAnimation() {
		return Optional.of(new Animation(812));
	}

	@Override
	public Optional<Projectile> castProjectile(Character cast, Character castOn) {
		return Optional.of(new Projectile(cast, castOn, 395, 44, 3, 43, 31, 0));
	}
	...
	@Override
	public int maximumHit() {
		return 7000; // x10 hits - change later
	}
...
SANGSTAFF2(new CombatNormalSpell() {
	@Override
	public Optional<Animation> castAnimation() {
	...
	@Override
	public int maximumHit() {
		return 50000; // x10 hits - change later
	}
	...
	// 988 Darkness // 606 Chaos // 502 skyrocket
	DARKSTAFF(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(1979));
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 988, 44, 3, 43, 31, 0));
		}
		...
		@Override
		public int maximumHit() {
			return 1200; // x10 hits - change later
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 502, 44, 3, 43, 31, 0));
		}
		...
		@Override
		public int maximumHit() {
			return 1500; // x10 hits - change later
		}
	...
	}), VIXIESTAFF(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(1979));
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 506, 44, 3, 43, 31, 0));
		}
		...
		@Override
		public int maximumHit() {
			return 1600; // x10 hits - change later
		}
	...
	}), PURPSTAFF(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(1979));
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 931, 44, 3, 43, 31, 0));
		}
		...
		@Override
		public int maximumHit() {
			return 2700; // x10 hits - change later
		}
	...
	GIANTSTAFF(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(1979));
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 2044, 44, 3, 43, 31, 0));
		}
		...
		@Override
		public int maximumHit() {
			return 4400; // x10 hits - change later
		}
	...
	}),MOONSTAFF(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(1979));
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 2923, 44, 3, 43, 31, 0));
		}
		...
		@Override
		public int maximumHit() {
			return 10650; // x10 hits - change later
		}
	...
	}),LMOONSTAFF(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(1979));
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 501, 44, 3, 43, 31, 0));
		}
	...
	}),BUUSTAFF(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(811));
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 2020, 44, 3, 43, 31, 0));
		}
		...
		@Override
		public int maximumHit() {
			return 15000; // x10 hits - change later
		}
	...
	}),MAXSTAFF(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(811));
		}
		...
		@Override
		public int maximumHit() {
			return 18000; // x10 hits - change later
		}
	...
	SANGGSTAFF(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(811));
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 71, 44, 3, 43, 31, 0));
		}
		...
		@Override
		public int maximumHit() {
			return 35000; // x10 hits - change later
		}
	...
	GMSTAFF2(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(811));
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 2029,  44, 3, 43, 31, 0));
		}
		...
		@Override
		public int maximumHit() {
			return 45000; // x10 hits - change later
		}
	...
	GMSTAFF3(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(811));
		}
		...
		@Override
		public int maximumHit() {
			return 65000; // x10 hits - change later
		}
	...
	ARROWSTAFF(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(1979));
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 559, 44, 3, 43, 31, 0));
		}
		...
		@Override
		public int maximumHit() {
			return 6650; // x10 hits - change later
		}
	...
	}), FLAMETHROWER(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(12153));
		}

		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 78, 78, 3, 4, 35, 0));
		}
		...
		@Override
		public int maximumHit() {
			return 5650; // x10 hits - change later
		}
	...
	ASTROGUN(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 150, 44, 3, 43, 31, 0));
		}
		...
		@Override
		public int maximumHit() {
			return 1650; // x10 hits - change later
		}
	...
	VENGEANCE_OTHER(new CombatEffectSpell() {
		...
		public void spellEffect(Character cast, Character castOn) {
			 ...
			 * if (castOn.isPlayer()) {
			 * 
			 * Player player = (Player) castOn; Player caster = (Player) cast;
			 * 
			 * caster.setPositionToFace(player.getPosition());
			 * 
			 * 
			 * if(!player.getLocation().isAidingAllowed() || player.getLocation() ==
			 * Location.DUEL_ARENA || player.hasVengeance() ||
			 * !caster.getLastVengeance().elapsed(30000)) {
			 * caster.getPacketSender().sendMessage("Vengeance other failed."); } else {
			 * caster.getPacketSender().sendMessage("You cast Vengeance on "+player.
			 * getUsername()+".");
			 * player.getPacketSender().sendMessage("Your were given Vengeance by "+caster.
			 * getUsername()); caster.getLastVengeance().reset(); player.performGraphic(new
			 * Graphic(725)); player.setHasVengeance(true); }
			 * 
			 * 
			 * }
			 */
		...
		@Override
		public Optional<Item[]> itemsRequired(Player player) {
			return Optional.of(new Item[] { new Item(557, 10), new Item(560, 2), new Item(9075, 3) });
		}
	...
	SMOKE_RUSH(new CombatAncientSpell() {
	...
	}),  ICE_BARRAGE1(new CombatNormalSpell() {
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 2143, 44, 3, 43, 31, 0));
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 605, 44, 3, 31, 31, 0));
		}
