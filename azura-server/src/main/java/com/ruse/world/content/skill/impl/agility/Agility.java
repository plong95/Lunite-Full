...
public class Agility {
	...
	public static boolean handleObject(Player p, GameObject object) {
		...
		if (agilityObject != null) {
			...
			AchievementsOLD.finishAchievement(p, AchievementDataOLD.CLIMB_AN_AGILITY_OBSTACLE);
			AchievementsOLD.doProgress(p, AchievementDataOLD.CLIMB_50_AGILITY_OBSTACLES);
			Achievements.doProgress(p, Achievements.Achievement.AGILITY);
		}
		return false;
	}
