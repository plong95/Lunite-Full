...
public class DefaultRangedCombatStrategy implements CombatStrategy {
    ...
    public CombatContainer attack(Character entity, Character victim) {
        if (entity.isNpc()) {
            ...
            switch (npc.getId()) {
                case 10020:
                    ammo = AmmunitionData.DRAGON_ARROW;
                    break;
                case 14207:
        ...
        CombatContainer container = new CombatContainer(entity, victim, 1, CombatType.RANGED, true);
    ...
    public int attackDistance(Character entity) {
        ...
        if (entity.isNpc()) {
            if (entity.getLocation() == Location.WAVE_MINIGAME)
                return 50;
            return 6;
        }
    ...
    private boolean checkAmmo(Player player) {
        ...
        if (data.getType() == RangedWeaponType.THROW)
            return true;
        if (data == RangedWeaponData.MINIGUN ||
                player.getEquipment().get(Equipment.WEAPON_SLOT).getId() == 22010
                ...
                || player.getEquipment().get(Equipment.WEAPON_SLOT).getId() == 23455
                || player.getEquipment().get(Equipment.WEAPON_SLOT).getId() == 23222
                || player.getEquipment().get(Equipment.WEAPON_SLOT).getId() == 23568
                || player.getEquipment().get(Equipment.WEAPON_SLOT).getId() == 23474
                ...
                || player.getEquipment().get(Equipment.WEAPON_SLOT).getId() == 23832
                || player.getEquipment().get(Equipment.WEAPON_SLOT).getId() == 23891
                || player.getEquipment().get(Equipment.WEAPON_SLOT).getId() == 23839
    ...
    public static void decrementAmmo(Player player, Position pos) {
        ...
        if (player.getEquipment().get(slot).getId() >= 23482
        && player.getEquipment().get(slot).getId() <= 23490
                || player.getEquipment().get(slot).getId() == 23705|| player.getEquipment().get(slot).getId() == 23742
                || player.getEquipment().get(slot).getId() == 23837){
            return;
        }
        ...
        if (player.getFireAmmo() != 22006) {
            ...
            if (SpecialAmmo.isAmmo(player)) {
                ...
                boolean avas1 = player.getEquipment().containsAny(20591, 20400, 7995, 23739, 22105, 23620,23689,  23717,22109, 23595, 23535);

                if (!(avas1 && Misc.getRandom(4) == 0))
            ...
            if (SpecialAmmo.forId(player.getEquipment().get(slot).getId()) != null)
                return;
        ...
        if (player.getEquipment().get(slot).getAmount() == 0) {
            if (player.getRangedWeaponData() == RangedWeaponData.MINIGUN ||
                    player.getEquipment().get(Equipment.WEAPON_SLOT).getId() == 22010
                    || player.getEquipment().get(Equipment.WEAPON_SLOT).getId() == 20553
                    || player.getEquipment().get(Equipment.WEAPON_SLOT).getId() == 21018
                    || player.getEquipment().get(Equipment.WEAPON_SLOT).getId() == 16337
    ...
    private static final int getModifiedDamage(Player player, Character target, CombatContainer container) {
        ...
        switch (ammo) {
            ...
            case 9242:
                ...
                long priceDamage = (int) (player.getSkillManager().getCurrentLevel(Skill.CONSTITUTION) * 0.08);
                if (priceDamage < 0) {
                    return (int) damage;
                }
                long dmg2 = (int) ((int) ((int) target.getConstitution() * 0.065) > 1000 ? 650 + Misc.getRandom(50)
