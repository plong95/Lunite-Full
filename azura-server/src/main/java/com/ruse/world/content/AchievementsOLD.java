...
public class AchievementsOLD {
	...
	public enum AchievementDataOLD {
		...
		CUT_AN_OAK_TREE(Difficulty.EASY, "Cut An Oak Tree", 37007, null, new Item(995, 1000000000)),
		BURN_AN_OAK_LOG(Difficulty.EASY, "Burn An Oak Log", 37008, null, new Item(995, 1000000000)),
		...
		SET_UP_A_CANNON(Difficulty.EASY, "Convert bill bag", 37025, null, new Item(2, 100)),
		...
		RUNECRAFT_500_BLOOD_RUNES(Difficulty.MEDIUM, "Runecraft 500 Blood Runes", 37055, new int[] { 18, 500 },
				new Item(7937, 350)),
		BURY_25_FROST_DRAGON_BONES(Difficulty.MEDIUM, "Use 25 Frost Dragon Bones", 37056, new int[] { 19, 25 },
				new Item(8716, 1)),
		FIRE_500_CANNON_BALLS(Difficulty.MEDIUM, "Upgrade 500 Items", 37057, new int[] { 20, 500 },
				new Item(2, 175)),
		...
		HARVEST_1000_TORSTOLS(Difficulty.HARD, "Harvest 1000 Torstols", 37077, new int[] { 32, 1000 },
				new Item(3025, 50)),
		INFUSE_250_STEEL_TITAN_POUCHES(Difficulty.HARD, "Infuse 250 Steel Titans", 37078, new int[] { 33, 250 },
				new Item(12163, 100)),
		...
		FIRE_5000_CANNON_BALLS(Difficulty.HARD, "Upgrade 5000 Items", 37085, new int[] { 40, 5000 },
				new Item(15241, 1)),
		...
		DEFEAT_KRIL_TSUTSAROTH(Difficulty.HARD, "Defeat K'ril Tsutsaroth", 37097, null, new Item(8716, 1)),
