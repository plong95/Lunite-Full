...
public class VoidOfDarkness {
    ...
    public static void updateInterface(Player player) {
        ...
        player.getPacketSender().sendString(126506, "Death of Trinity");
