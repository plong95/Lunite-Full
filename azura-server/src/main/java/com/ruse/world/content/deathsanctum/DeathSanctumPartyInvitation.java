...
public class DeathSanctumPartyInvitation extends Dialogue {
	
	public DeathSanctumPartyInvitation(Player inviter, Player p) {
	...
	public Dialogue nextDialogue() {
		return new Dialogue() {
			...
			public void specialAction() {
				p.getMinigameAttributes().getDeathSanctumAttributes().setInvitation(inviter.getSanctumOfDeathParty());
