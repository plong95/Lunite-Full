...
public class PetShop {
    ...
    public static Object[] getPrice(int item) {
        switch (item) {
            ...
            case 23042:
            case 23043:
                return new Object[]{350000, "Aspect tokens"};
            case 23114://kil
                return new Object[]{500000, "Aspect tokens"};
            case 23115:
                return new Object[]{250000, "Aspect tokens"};
            case 23116:
                return new Object[]{500000, "Aspect tokens"};
            case 23117:
                return new Object[]{700000, "Aspect tokens"};
            case 23164:
                return new Object[]{1000000, "Aspect tokens"};
            case 23108:
            case 23109:
                return new Object[]{400000, "Aspect tokens"};
            case 23110:
                return new Object[]{500000, "Aspect tokens"};
            case 23112:
                return new Object[]{1500000, "Aspect tokens"};
            case 23111:
                return new Object[]{5000000, "Aspect tokens"};
        }
        return new Object[]{100000000, "Aspect tokens"};
    }
