...
public enum CLUESCROLL {
	...
	HOME_TREASURE(2722, new Position(2975, 2507), -1, "Dig near the scoreboard at home."),
	CHILL_GATES(2723, new Position(2970, 2533), -1, "Dig infront of Lottie."),
	TAVERLY_DUNG_PIPE(2725, new Position(2886, 9799), -1, "Dig next to a pipe in the Taverly Dungeon."),
	DAEMONHEIM_SKILLCAPE_STAND(2727, new Position(2991, 2547), -1, "Dig near prestige master."),
	...
	NEX_LANDSLIDE(2735, new Position(3165, 3487), -1, "dig at the starterzone, watch out for groudon!."),
	BARROWS_FOREST(2737, new Position(3577, 3321), -1, "Dig around the trees beside the shed at Barrows."),
	BEHIND_EDGEVILLE_BANK(2739, new Position(3100, 3495), -1, "Dig behind the Edgeville bank."),
	...
	EMILY_HOME(2785, new Position(3092, 3498), -1, "Try not to donate dig in front of the donator store."),
	YELLOW_ENERGY(2786, new Position(2134, 5534, 3), -1, "Dig infront of this Runecrafting Wizard."),
	CRYSTAL_CHEST(2788, new Position(2970, 2525), -1, "Dig in front of the Crystal Chest."),
	HOME_MERCHANT(2790, new Position(3095, 3479), -1, "Dig in inside the slayer house south of home."),
	...
	SHOP_BANKER(3548, new Position(3097, 3489), -1, "Dig beside a bank booth at home."),
	USE_ON_EMILY(3550, null, 605, "Use this Cluescroll on the vote manager.");
	...
	public static int[] hardClueId = { 2722, 2723, 2725, 2727, 2729, 2731, 2733, 2735, 2737, 2739, 2741, 2743, 2745,
			2747, 2773, 2774, 2776, 2778, 2780, 2782, 2783, 2785, 2786, 2788, 2790, 2792, 2793, 2794, 2796, 2797, 2799,
			3520, 3522, 3524, 3525, 3526, 3528, 3530, 3532, 3534, 3536, 3538, 3540, 3542, 3544, 3546, 3548, 3550 };

	public static int hardCasket = 2724;

	public static Item[] consumableRewards = { new Item(556, 250), new Item(558, 250), new Item(555, 250),
			new Item(554, 250), new Item(557, 250), new Item(559, 250), new Item(564, 250), new Item(562, 250),
			new Item(566, 250), new Item(9075, 250), new Item(563, 250), new Item(561, 250), new Item(560, 250),
			new Item(4698, 250), new Item(565, 250), // runes

			new Item(882, 350), new Item(884, 300), new Item(886, 250), new Item(888, 200), new Item(890, 175),
			new Item(892, 165), new Item(11212, 160), new Item(810, 300), new Item(811, 250), new Item(11230, 100),
			new Item(877, 100), new Item(9140, 100), new Item(9141, 100), new Item(9142, 100), new Item(9143, 100),
			new Item(9144, 100), new Item(9240, 100), new Item(9241, 100), new Item(9242, 100), new Item(9243, 100),
			new Item(9341, 100), new Item(9244, 75), new Item(9245, 75), new Item(864, 100), new Item(863, 100),
			new Item(865, 100), new Item(866, 100), new Item(867, 100), new Item(868, 100), new Item(2, 250), // Ammunition

			new Item(326, 500), new Item(340, 500), new Item(330, 500), new Item(362, 400), new Item(380, 190),
			new Item(374, 120), new Item(7947, 75), new Item(386, 40), new Item(392, 20), new Item(15273, 20), // Food
			new Item(2443, 50), new Item(2437, 55), new Item(2441, 50), new Item(2445, 45), new Item(3041, 30),
			new Item(6686, 20), new Item(2453, 50), new Item(3025, 15), new Item(2435, 25), new Item(2447, 50), // potions
			new Item(1734, 1000) // thread
	};

	public static Item[] ultraRareRewards = { new Item(22041, 1), // Black h'ween
			new Item(14484, 1), // dragon claws
			new Item(18685, 1), // dragon claws
			new Item(19780, 1), // korsai
			new Item(22012, 1), // Crimson's Katana
	};

	public static Item[] equipmentRewards = { new Item(10362, 1), // Glory (T)
			new Item(7414, 1), new Item(4151, 1), new Item(15441, 1), new Item(15442, 1), new Item(15443, 1),
			new Item(15444, 1), new Item(22007), // whips
			new Item(19293, 1), new Item(19333, 1), // frost dragon mask, fury (or) kit
			new Item(18744, 1), new Item(18745, 1), new Item(18746, 1), // halos
			new Item(15486, 1), new Item(14004, 1), new Item(14005, 1), new Item(14006, 1), new Item(14007, 1), // staff
																												// of
																												// light
			...
			new Item(2605, 1), new Item(2599, 1), new Item(2601, 1), new Item(2603, 1), new Item(3474, 1), // adamant
																											// (t)
			new Item(2611, 1), new Item(3475, 1), new Item(2613, 1), new Item(2607, 1), new Item(2609, 1), // adamant
																											// (g)
			...
			new Item(7380, 1), new Item(7372, 1), new Item(7378, 1), new Item(7370, 1), new Item(7368, 1),
			new Item(7364, 1), new Item(7366, 1), new Item(7362, 1), // range (g) and (t)
			// new Item(10374, 1), new Item(10370, 1), new Item(10372, 1), new Item(10368,
			// 1), //zammy dragonhide set
	...
	public static Item[] thirdAgeRewards = { new Item(10350, 1), new Item(10348, 1), new Item(10346, 1),
			new Item(10352, 1), // 3rd age melee
			...
			new Item(19308, 1), new Item(19311, 1), new Item(19314, 1), new Item(19317, 1), new Item(19320, 1), // 3rd
																												// age
																												// druid
	};
	...
	public static void mockCasket(int iterations) {
		...
		for (int i = 0; i < iterations; i++) {
			...
			String log = "[" + i + "] " + a.getAmount() + "x " + ItemDefinition.forId(a.getId()).getName() + ", "
					+ b.getAmount() + "x " + ItemDefinition.forId(b.getId()).getName() + ", " + c.getAmount() + "x "
					+ ItemDefinition.forId(c.getId()).getName() + ".";
	...
	public static void openCasket(Player player) {
		...
		if (player.getInventory().getAmount(hardCasket) != (int) (originalCount - 1)) {
			...
			if (player.getRights().isHighStaff()) {
		...
		if (ultraRare || player.getUsername().equalsIgnoreCase("debug")) {
			...
			World.sendMessage("<img=101><col=e3522c><shad=0> " + player.getUsername() + " has looted a "
					+ ItemDefinition.forId(a.getId()).getName() + " from a Treasure Trail!");
		} else {
		...
		if (thirdAge) {
			...
			World.sendMessage("<img=101><col=e3522c><shad=0> " + player.getUsername() + " has looted a "
					+ ItemDefinition.forId(c.getId()).getName() + " from a Treasure Trail!");
		} else if (equip) {
		...
		String col = "<col=255>";
		player.getPacketSender().sendMessage(col + "<img=5> Your casket contained...");
		player.getPacketSender()
				.sendMessage(col + a.getAmount() + "x " + ItemDefinition.forId(a.getId()).getName() + ",")
				.sendMessage(col + b.getAmount() + "x " + ItemDefinition.forId(b.getId()).getName() + ",")
				.sendMessage(col + c.getAmount() + "x " + ItemDefinition.forId(c.getId()).getName() + ".");
		PlayerLogs.log("1 - hard clue caskets",
				player.getUsername() + " has looted: " + a.getAmount() + "x "
						+ ItemDefinition.forId(a.getId()).getName() + ", " + b.getAmount() + "x "
						+ ItemDefinition.forId(b.getId()).getName() + ", " + c.getAmount() + "x "
						+ ItemDefinition.forId(c.getId()).getName() + ".");
		player.getClickDelay().reset();
	}

	public static void awardCasket(Player player) {
	...
	public static boolean handleClueDig(Player player) {
		for (int i = 0; i < CLUESCROLL.values().length; i++) {
			if (player.getInventory().contains(CLUESCROLL.values()[i].getClueId())
					&& player.getPosition().getX() == CLUESCROLL.values()[i].getDigTile().getX()
					&& player.getPosition().getY() == CLUESCROLL.values()[i].getDigTile().getY()) {
				if (player.getRights().isHighStaff()) {
					player.getPacketSender()
							.sendMessage("[debug] You are on: " + CLUESCROLL.values()[i].getDigTile().getX() + ", "
									+ CLUESCROLL.values()[i].getDigTile().getY() + ", index: " + i);
				}
				...
				if ((player.getPointsHandler().getClueSteps() >= 3 && c == 1)
						|| player.getPointsHandler().getClueSteps() >= 10) {
					awardCasket(player);
				} else {
	...
	public static boolean handleNpcUse(Player player, int npcid) {
		for (int i = 0; i < CLUESCROLL.values().length; i++) {
			if (player.getInventory().contains(CLUESCROLL.values()[i].getClueId())
					&& npcid == CLUESCROLL.values()[i].getNpcId()) {
				if (player.getRights().isHighStaff()) {
					player.getPacketSender().sendMessage("[debug] Your NPC ID: " + npcid + ", CLUE npcId "
							+ CLUESCROLL.values()[i].getNpcId() + ", index: " + i);
				}
				player.getInventory().delete(CLUESCROLL.values()[i].getClueId(), 1);
				player.getPointsHandler().setClueSteps(1, true);
				int c = Misc.getRandom(1);
		...
		try {
			...
			for (int i = 0; i < list.size(); i++) {
				...
				if (newline && toSend >= secondcap) {
					...
					/*
					 * player.getPacketSender().sendMessage("<shad=ffffff>"+drops.getDropList()[i].
					 * getItem().getAmount() + "x <shad=0>" +
					 * Misc.getColorBasedOnValue(drops.getDropList()[i].getItem().getDefinition().
					 * getValue()*drops.getDropList()[i].getItem().getAmount()) +
					 * drops.getDropList()[i].getItem().getDefinition().getName() + "<shad=-1>@bla@"
					 * + (player.getRights().OwnerDeveloperOnly() ?
					 * " at a drop rate of 1/"+(dropChance.getRandom() ==
					 * DropChance.ALWAYS.getRandom() ? "1" : dropChance.getRandom()) : "") +
					 * "<shad=ffffff>.");
					 */
					continue;
				}
