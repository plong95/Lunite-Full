...
public class GiveItem extends ListenerAdapter {
    ...
    public void onGuildMessageReceived(GuildMessageReceivedEvent e) {
        ...
        if (target == null) {
            ...
            e.getMessage().getTextChannel().sendMessage(name + " must be online to give them stuff!").queue();
        } else {
            ...
            e.getMessage().getTextChannel().sendMessage("Gave " + amount + "x " + ItemDefinition.forId(id).getName() + " to " + name + ".").queue();

            DiscordMessager.sendGiveItem(Misc.capitalizeJustFirst(name),
                    "By: " + user.getName()
